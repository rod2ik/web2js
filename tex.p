...
{:6}const{11:}mem_max=8000000;mem_min=0;buf_size=300000;error_line=79;
half_error_line=50;max_print_line=79;stack_size=5000;max_in_open=15;
font_max=256;font_mem_size=800000;param_size=10000;nest_size=500;
max_strings=500000;string_vacancies=90000;pool_size=6250000;
save_size=200000;trie_size=1000000;trie_op_size=35111;
dvi_buf_size=16384;file_name_size=80;
pool_name='tex.pool                                ';
...
{:594}{920:}trie_pointer=0..trie_size;{:920}{925:}hyph_pointer=0..8191;
...
{:246}{253:}eqtb:array[1..604006]of memory_word;
xeq_level:array[603163..604006]of quarterword;
{:253}{256:}hash:array[514..600780]of two_halves;hash_used:halfword;
...
line_diff:integer;{:872}{892:}hc:array[0..65]of 0..256;hn:0..64;
...
{:771}{928:}for z:=0 to 8191 do begin hyph_word[z]:=0;hyph_list[z]:=0;
...
for k:=7999987 to 8000000 do mem[k]:=mem[lo_mem_max];
{790:}mem[7999990].hh.lh:=604614;{:790}{797:}mem[7999991].hh.rh:=256;
mem[7999991].hh.lh:=0;{:797}{820:}mem[7999993].hh.b0:=1;
mem[7999994].hh.lh:=65535;mem[7999993].hh.b1:=0;
{:820}{981:}mem[8000000].hh.b1:=255;mem[8000000].hh.b0:=1;
mem[8000000].hh.rh:=8000000;{:981}{988:}mem[7999998].hh.b0:=10;
mem[7999998].hh.b1:=0;{:988};avail:=0;mem_end:=8000000;
hi_mem_min:=7999987;var_used:=20;dyn_used:=14;
{:164}{222:}eqtb[600781].hh.b0:=101;eqtb[600781].hh.rh:=0;
eqtb[600781].hh.b1:=0;for k:=1 to 600780 do eqtb[k]:=eqtb[600781];
{:222}{228:}eqtb[600782].hh.rh:=0;eqtb[600782].hh.b1:=1;
eqtb[600782].hh.b0:=117;
for k:=600783 to 601311 do eqtb[k]:=eqtb[600782];
mem[0].hh.rh:=mem[0].hh.rh+530;{:228}{232:}eqtb[601312].hh.rh:=0;
eqtb[601312].hh.b0:=118;eqtb[601312].hh.b1:=1;
for k:=601313 to 601577 do eqtb[k]:=eqtb[600781];eqtb[601578].hh.rh:=0;
eqtb[601578].hh.b0:=119;eqtb[601578].hh.b1:=1;
for k:=601579 to 601833 do eqtb[k]:=eqtb[601578];eqtb[601834].hh.rh:=0;
eqtb[601834].hh.b0:=120;eqtb[601834].hh.b1:=1;
for k:=601835 to 601882 do eqtb[k]:=eqtb[601834];eqtb[601883].hh.rh:=0;
eqtb[601883].hh.b0:=120;eqtb[601883].hh.b1:=1;
for k:=601884 to 603162 do eqtb[k]:=eqtb[601883];
for k:=0 to 255 do begin eqtb[601883+k].hh.rh:=12;
eqtb[602907+k].hh.rh:=k+0;eqtb[602651+k].hh.rh:=1000;end;
eqtb[601896].hh.rh:=5;eqtb[601915].hh.rh:=10;eqtb[601975].hh.rh:=0;
eqtb[601920].hh.rh:=14;eqtb[602010].hh.rh:=15;eqtb[601883].hh.rh:=9;
for k:=48 to 57 do eqtb[602907+k].hh.rh:=k+28672;
for k:=65 to 90 do begin eqtb[601883+k].hh.rh:=11;
eqtb[601883+k+32].hh.rh:=11;eqtb[602907+k].hh.rh:=k+28928;
eqtb[602907+k+32].hh.rh:=k+28960;eqtb[602139+k].hh.rh:=k+32;
eqtb[602139+k+32].hh.rh:=k+32;eqtb[602395+k].hh.rh:=k;
eqtb[602395+k+32].hh.rh:=k;eqtb[602651+k].hh.rh:=999;end;
{:232}{240:}for k:=603163 to 603473 do eqtb[k].int:=0;
eqtb[603180].int:=1000;eqtb[603164].int:=10000;eqtb[603204].int:=1;
eqtb[603203].int:=25;eqtb[603208].int:=92;eqtb[603211].int:=13;
for k:=0 to 255 do eqtb[603474+k].int:=-1;eqtb[603520].int:=0;
{:240}{250:}for k:=603730 to 604006 do eqtb[k].int:=0;
{:250}{258:}hash_used:=600514;cs_count:=0;eqtb[600523].hh.b0:=116;
hash[600523].rh:=502;{:258}{552:}font_ptr:=0;fmem_ptr:=7;
font_name[0]:=801;font_area[0]:=338;hyphen_char[0]:=45;skew_char[0]:=-1;
...
{:951}{1216:}hash[600514].rh:=1190;{:1216}{1301:}format_ident:=1257;
{:1301}{1369:}hash[600522].rh:=1296;eqtb[600522].hh.b1:=1;
eqtb[600522].hh.b0:=113;eqtb[600522].hh.rh:=0;{:1369}{:8}end;
...
begin if{244:}s=eqtb[603212].int{:244}then if selector<20 then begin
...
if({244:}s=eqtb[603212].int{:244})then if selector<20 then begin
print_ln;goto 10;end;nl:=eqtb[603212].int;eqtb[603212].int:=-1;
j:=str_start[s];while j<str_start[s+1]do begin print_char(str_pool[j]);
j:=j+1;end;eqtb[603212].int:=nl;goto 10;end;j:=str_start[s];
...
begin{243:}c:=eqtb[603208].int{:243};
if c>=0 then if c<256 then print(c);slow_print(s);end;
{:63}{64:}procedure print_the_digs(k:eight_bits);
...
if eqtb[601883+p-257].hh.rh=11 then print_char(32);
end else if p<1 then print_esc(506)else print(p-1)else if p>=600781 then
...
goto 10;clear_for_error_prompt;begin;print(264);term_input;end;
...
69:if base_ptr>0 then if input_stack[base_ptr].name_field>=256 then
begin print_nl(265);slow_print(input_stack[base_ptr].name_field);
print(266);print_int(line);interaction:=2;jump_out;end;
...
if base_ptr>0 then if input_stack[base_ptr].name_field>=256 then print(
270);if deletions_allowed then print_nl(271);print_nl(272);
end{:85}{:84};end{:83};error_count:=error_count+1;
...
3:begin print(571);p:=7999997;end;4:begin print(572);p:=7999996;end;
...
mem[p].hh.b1:=n+1;mem[p+1].hh.rh:=0;q:={224:}eqtb[600782+n].hh.rh{:224};
...
var p:halfword;
begin temp_ptr:=new_spec({224:}eqtb[600782+n].hh.rh{:224});
...
[255:]for q:=1 to 601833 do begin if eqtb[q].hh.rh=p then begin print_nl
...
[933:]for q:=0 to 8191 do begin if hyph_list[q]=p then begin print_nl(
940);print_int(q);print_char(41);end;end[:933];end;}
...
hash[600524+mem[p].hh.b0].rh){:267};print_char(32);
...
mem[p].hh.b0>font_max)then print_char(42)else{267:}print_esc(hash[
600524+mem[p].hh.b0].rh){:267};print_char(32);print(mem[p].hh.b1-0);end;
end;procedure print_mark(p:integer);begin print_char(123);
...
3:if mem[p].hh.lh=0 then begin print_ln;print_current_string;print(860);
end else show_info;others:end;pool_ptr:=pool_ptr-1;end;end;
{:692}{694:}procedure print_style(c:integer);
begin case c div 2 of 0:print_esc(861);1:print_esc(862);
2:print_esc(863);3:print_esc(864);others:print(865)end;end;
...
8:{1356:}case mem[p].hh.b1 of 0:begin print_write_whatsit(1285,p);
print_char(61);
...
2:print_write_whatsit(1286,p);3:begin print_esc(1287);
print_mark(mem[p+1].hh.rh);end;4:begin print_esc(1289);
print_int(mem[p+1].hh.rh);print(1292);print_int(mem[p+1].hh.b0);
print_char(44);print_int(mem[p+1].hh.b1);print_char(41);end;
others:print(1293)end{:1356};
...
b0 of 16:print_esc(866);17:print_esc(867);18:print_esc(868);
19:print_esc(869);20:print_esc(870);21:print_esc(871);22:print_esc(872);
23:print_esc(873);27:print_esc(874);26:print_esc(875);29:print_esc(539);
24:begin print_esc(533);print_delimiter(p+4);end;
28:begin print_esc(508);print_fam_and_char(p+4);end;
30:begin print_esc(876);print_delimiter(p+1);end;
31:begin print_esc(877);print_delimiter(p+1);end;end;
if mem[p].hh.b1<>0 then if mem[p].hh.b1=1 then print_esc(878)else
print_esc(879);if mem[p].hh.b0<30 then print_subsidiary_data(p+1,46);
print_subsidiary_data(p+2,94);print_subsidiary_data(p+3,95);end{:696};
25:{697:}begin print_esc(880);
if mem[p+1].int=1073741824 then print(881)else print_scaled(mem[p+1].int
);
if(mem[p+4].qqqq.b0<>0)or(mem[p+4].qqqq.b1<>0)or(mem[p+4].qqqq.b2<>0)or(
mem[p+4].qqqq.b3<>0)then begin print(882);print_delimiter(p+4);end;
if(mem[p+5].qqqq.b0<>0)or(mem[p+5].qqqq.b1<>0)or(mem[p+5].qqqq.b2<>0)or(
mem[p+5].qqqq.b3<>0)then begin print(883);print_delimiter(p+5);end;
...
begin{236:}depth_threshold:=eqtb[603188].int;
breadth_max:=eqtb[603187].int{:236};
...
2,4:free_node(p,2);others:confusion(1295)end;goto 30;end{:1358};
...
2,4:begin r:=get_node(2);words:=2;end;others:confusion(1294)end{:1357};
...
if p=0 then begin{986:}if 7999998<>page_tail then begin print_nl(980);
if output_active then print(981);show_box(mem[7999998].hh.rh);
if page_contents>0 then begin print_nl(982);print_totals;print_nl(983);
print_scaled(page_so_far[0]);r:=mem[8000000].hh.rh;
while r<>8000000 do begin print_ln;print_esc(330);t:=mem[r].hh.b1-0;
print_int(t);print(984);
if eqtb[603218+t].int=1000 then t:=mem[r+3].int else t:=x_over_n(mem[r+3
].int,1000)*eqtb[603218+t].int;print_scaled(t);
if mem[r].hh.b0=1 then begin q:=7999998;t:=0;repeat q:=mem[q].hh.rh;
if(mem[q].hh.b0=3)and(mem[q].hh.b1=mem[r].hh.b1)then t:=t+1;
until q=mem[r+1].hh.lh;print(985);print_int(t);print(986);end;
r:=mem[r].hh.rh;end;end;end{:986};
if mem[7999999].hh.rh<>0 then print_nl(368);end;
...
begin sys_time:=12*60;sys_day:=4;sys_month:=7;sys_year:=1776;
eqtb[603183].int:=sys_time;eqtb[603184].int:=sys_day;
eqtb[603185].int:=sys_month;eqtb[603186].int:=sys_year;end;
{:241}{245:}procedure begin_diagnostic;begin old_setting:=selector;
if(eqtb[603192].int<=0)and(selector=19)then begin selector:=selector-1;
...
print(chr_code);end;
{227:}75,76:if chr_code<600800 then print_skip_param(chr_code-600782)
else if chr_code<601056 then begin print_esc(395);
print_int(chr_code-600800);end else begin print_esc(396);
print_int(chr_code-601056);end;
{:227}{231:}72:if chr_code>=601322 then begin print_esc(407);
print_int(chr_code-601322);
end else case chr_code of 601313:print_esc(398);601314:print_esc(399);
601315:print_esc(400);601316:print_esc(401);601317:print_esc(402);
601318:print_esc(403);601319:print_esc(404);601320:print_esc(405);
others:print_esc(406)end;
{:231}{239:}73:if chr_code<603218 then print_param(chr_code-603163)else
begin print_esc(476);print_int(chr_code-603218);end;
{:239}{249:}74:if chr_code<603751 then print_length_param(chr_code
-603730)else begin print_esc(500);print_int(chr_code-603751);end;
...
{:469}{488:}105:case chr_code of 1:print_esc(758);2:print_esc(759);
3:print_esc(760);4:print_esc(761);5:print_esc(762);6:print_esc(763);
7:print_esc(764);8:print_esc(765);9:print_esc(766);10:print_esc(767);
11:print_esc(768);12:print_esc(769);13:print_esc(770);14:print_esc(771);
15:print_esc(772);16:print_esc(773);others:print_esc(757)end;
{:488}{492:}106:if chr_code=2 then print_esc(774)else if chr_code=4 then
print_esc(775)else print_esc(776);
{:492}{781:}4:if chr_code=256 then print_esc(898)else begin print(902);
print(chr_code);end;
5:if chr_code=257 then print_esc(899)else print_esc(900);
{:781}{984:}81:case chr_code of 0:print_esc(970);1:print_esc(971);
2:print_esc(972);3:print_esc(973);4:print_esc(974);5:print_esc(975);
6:print_esc(976);others:print_esc(977)end;
{:984}{1053:}14:if chr_code=1 then print_esc(1026)else print_esc(1025);
{:1053}{1059:}26:case chr_code of 4:print_esc(1027);0:print_esc(1028);
1:print_esc(1029);2:print_esc(1030);others:print_esc(1031)end;
27:case chr_code of 4:print_esc(1032);0:print_esc(1033);
1:print_esc(1034);2:print_esc(1035);others:print_esc(1036)end;
28:print_esc(336);29:print_esc(340);30:print_esc(342);
{:1059}{1072:}21:if chr_code=1 then print_esc(1054)else print_esc(1055);
22:if chr_code=1 then print_esc(1056)else print_esc(1057);
20:case chr_code of 0:print_esc(409);1:print_esc(1058);
2:print_esc(1059);3:print_esc(965);4:print_esc(1060);5:print_esc(967);
others:print_esc(1061)end;
31:if chr_code=100 then print_esc(1063)else if chr_code=101 then
print_esc(1064)else if chr_code=102 then print_esc(1065)else print_esc(
1062);
{:1072}{1089:}43:if chr_code=0 then print_esc(1081)else print_esc(1080);
{:1089}{1108:}25:if chr_code=10 then print_esc(1092)else if chr_code=11
then print_esc(1091)else print_esc(1090);
23:if chr_code=1 then print_esc(1094)else print_esc(1093);
24:if chr_code=1 then print_esc(1096)else print_esc(1095);
{:1108}{1115:}47:if chr_code=1 then print_esc(45)else print_esc(349);
{:1115}{1143:}48:if chr_code=1 then print_esc(1128)else print_esc(1127);
{:1143}{1157:}50:case chr_code of 16:print_esc(866);17:print_esc(867);
18:print_esc(868);19:print_esc(869);20:print_esc(870);21:print_esc(871);
22:print_esc(872);23:print_esc(873);26:print_esc(875);
others:print_esc(874)end;
51:if chr_code=1 then print_esc(878)else if chr_code=2 then print_esc(
879)else print_esc(1129);{:1157}{1170:}53:print_style(chr_code);
{:1170}{1179:}52:case chr_code of 1:print_esc(1148);2:print_esc(1149);
3:print_esc(1150);4:print_esc(1151);5:print_esc(1152);
others:print_esc(1147)end;
{:1179}{1189:}49:if chr_code=30 then print_esc(876)else print_esc(877);
{:1189}{1209:}93:if chr_code=1 then print_esc(1171)else if chr_code=2
then print_esc(1172)else print_esc(1173);
97:if chr_code=0 then print_esc(1174)else if chr_code=1 then print_esc(
1175)else if chr_code=2 then print_esc(1176)else print_esc(1177);
{:1209}{1220:}94:if chr_code<>0 then print_esc(1192)else print_esc(1191)
;{:1220}{1223:}95:case chr_code of 0:print_esc(1193);1:print_esc(1194);
2:print_esc(1195);3:print_esc(1196);4:print_esc(1197);5:print_esc(1198);
others:print_esc(1199)end;68:begin print_esc(513);print_hex(chr_code);
end;69:begin print_esc(524);print_hex(chr_code);end;
{:1223}{1231:}85:if chr_code=601883 then print_esc(415)else if chr_code=
602907 then print_esc(419)else if chr_code=602139 then print_esc(416)
else if chr_code=602395 then print_esc(417)else if chr_code=602651 then
print_esc(418)else print_esc(477);86:print_size(chr_code-601835);
{:1231}{1251:}99:if chr_code=1 then print_esc(953)else print_esc(941);
{:1251}{1255:}78:if chr_code=0 then print_esc(1217)else print_esc(1218);
{:1255}{1261:}87:begin print(1226);slow_print(font_name[chr_code]);
...
2:print_esc(276);others:print_esc(1227)end;
{:1263}{1273:}60:if chr_code=0 then print_esc(1229)else print_esc(1228);
{:1273}{1278:}58:if chr_code=0 then print_esc(1230)else print_esc(1231);
{:1278}{1287:}57:if chr_code=602139 then print_esc(1237)else print_esc(
1238);{:1287}{1292:}19:case chr_code of 1:print_esc(1240);
2:print_esc(1241);3:print_esc(1242);others:print_esc(1239)end;
{:1292}{1295:}101:print(1249);111:print(1250);112:print_esc(1251);
113:print_esc(1252);114:begin print_esc(1171);print_esc(1252);end;
115:print_esc(1253);{:1295}{1346:}59:case chr_code of 0:print_esc(1285);
1:print_esc(594);2:print_esc(1286);3:print_esc(1287);4:print_esc(1288);
5:print_esc(1289);others:print(1290)end;{:1346}others:print(567)end;end;
{:298}{procedure show_eqtb(n:halfword);
begin if n<1 then print_char(63)else if n<600782 then[223:]begin
sprint_cs(n);print_char(61);print_cmd_chr(eqtb[n].hh.b0,eqtb[n].hh.rh);
if eqtb[n].hh.b0>=111 then begin print_char(58);
show_token_list(mem[eqtb[n].hh.rh].hh.rh,0,32);end;
end[:223]else if n<601312 then[229:]if n<600800 then begin
print_skip_param(n-600782);print_char(61);
if n<600797 then print_spec(eqtb[n].hh.rh,397)else print_spec(eqtb[n].hh
.rh,337);end else if n<601056 then begin print_esc(395);
print_int(n-600800);print_char(61);print_spec(eqtb[n].hh.rh,397);
end else begin print_esc(396);print_int(n-601056);print_char(61);
print_spec(eqtb[n].hh.rh,337);
end[:229]else if n<603163 then[233:]if n=601312 then begin print_esc(408
);print_char(61);
if eqtb[601312].hh.rh=0 then print_char(48)else print_int(mem[eqtb[
601312].hh.rh].hh.lh);
end else if n<601322 then begin print_cmd_chr(72,n);print_char(61);
if eqtb[n].hh.rh<>0 then show_token_list(mem[eqtb[n].hh.rh].hh.rh,0,32);
end else if n<601578 then begin print_esc(407);print_int(n-601322);
print_char(61);
if eqtb[n].hh.rh<>0 then show_token_list(mem[eqtb[n].hh.rh].hh.rh,0,32);
end else if n<601834 then begin print_esc(409);print_int(n-601578);
print_char(61);
if eqtb[n].hh.rh=0 then print(410)else begin depth_threshold:=0;
breadth_max:=1;show_node_list(eqtb[n].hh.rh);end;
end else if n<601883 then[234:]begin if n=601834 then print(411)else if
n<601851 then begin print_esc(412);print_int(n-601835);
end else if n<601867 then begin print_esc(413);print_int(n-601851);
end else begin print_esc(414);print_int(n-601867);end;print_char(61);
print_esc(hash[600524+eqtb[n].hh.rh].rh);
end[:234]else[235:]if n<602907 then begin if n<602139 then begin
print_esc(415);print_int(n-601883);
end else if n<602395 then begin print_esc(416);print_int(n-602139);
end else if n<602651 then begin print_esc(417);print_int(n-602395);
end else begin print_esc(418);print_int(n-602651);end;print_char(61);
print_int(eqtb[n].hh.rh);end else begin print_esc(419);
print_int(n-602907);print_char(61);print_int(eqtb[n].hh.rh-0);
end[:235][:233]else if n<603730 then[242:]begin if n<603218 then
print_param(n-603163)else if n<603474 then begin print_esc(476);
print_int(n-603218);end else begin print_esc(477);print_int(n-603474);
end;print_char(61);print_int(eqtb[n].int);
end[:242]else if n<=604006 then[251:]begin if n<603751 then
print_length_param(n-603730)else begin print_esc(500);
print_int(n-603751);end;print_char(61);print_scaled(eqtb[n].int);
print(397);end[:251]else print_char(63);end;}
...
if hash[p].lh=0 then begin if no_new_control_sequence then p:=600781
else{260:}begin if hash[p].rh>0 then begin repeat if(hash_used=514)then
overflow(503,600000);hash_used:=hash_used-1;until hash[hash_used].rh=0;
...
end else save_stack[save_ptr]:=eqtb[600781];
{283:}if p<603163 then if eqtb[p].hh.b1=1 then begin eq_destroy(
save_stack[save_ptr]);{if eqtb[603200].int>0 then restore_trace(p,544);}
end else begin eq_destroy(eqtb[p]);eqtb[p]:=save_stack[save_ptr];
{if eqtb[603200].int>0 then restore_trace(p,545);}
end else if xeq_level[p]<>1 then begin eqtb[p]:=save_stack[save_ptr];
xeq_level[p]:=l;{if eqtb[603200].int>0 then restore_trace(p,545);}
end else begin{if eqtb[603200].int>0 then restore_trace(p,544);}
...
begin if(mag_set>0)and(eqtb[603180].int<>mag_set)then begin begin if
interaction=3 then;print_nl(262);print(547);end;
print_int(eqtb[603180].int);print(548);print_nl(549);begin help_ptr:=2;
help_line[1]:=550;help_line[0]:=551;end;int_error(mag_set);
geq_word_define(603180,mag_set);end;
if(eqtb[603180].int<=0)or(eqtb[603180].int>32768)then begin begin if
interaction=3 then;print_nl(262);print(552);end;begin help_ptr:=1;
help_line[0]:=553;end;int_error(eqtb[603180].int);
geq_word_define(603180,1000);end;mag_set:=eqtb[603180].int;end;
...
if(base_ptr=input_ptr)or bottom_line or(nn<eqtb[603217].int)then{312:}
...
if buffer[cur_input.limit_field]=eqtb[603211].int then j:=cur_input.
...
end{:312}else if nn=eqtb[603217].int then begin print_nl(277);nn:=nn+1;
...
if eqtb[603193].int>1 then begin begin_diagnostic;print_nl(338);
case t of 14:print_esc(351);15:print_esc(594);
others:print_cmd_chr(72,t+601307)end;print(556);token_show(p);
...
mem[p].hh.lh:=604610;align_state:=-1000000;end;5:begin print(573);
...
if cur_cs<>0 then cur_cs:=0 else help_line[2]:=603;cur_tok:=604613;
...
cur_input.loc_field:=cur_input.loc_field+1;
21:cur_cmd:=eqtb[601883+cur_chr].hh.rh;
...
cat:=eqtb[601883+cur_chr].hh.rh;k:=k+1;
...
buffer[k];cat:=eqtb[601883+cur_chr].hh.rh;k:=k+1;
...
goto 20;end;
if(eqtb[603211].int<0)or(eqtb[603211].int>255)then cur_input.limit_field
:=cur_input.limit_field-1 else buffer[cur_input.limit_field]:=eqtb[
603211].int;first:=cur_input.limit_field+1;
...
if interaction>1 then begin if(eqtb[603211].int<0)or(eqtb[603211].int>
255)then cur_input.limit_field:=cur_input.limit_field+1;
...
if cur_cmd=63 then begin_token_list(7999990,2)else begin_token_list(mem[
...
if eqtb[603191].int>0 then if interaction>1 then begin;print_ln;
...
if eqtb[603193].int>0 then{401:}begin begin_diagnostic;print_ln;
...
repeat mem[7999997].hh.rh:=0;
if(mem[r].hh.lh>3583)or(mem[r].hh.lh<3328)then s:=0 else begin match_chr
:=mem[r].hh.lh-3328;s:=mem[r].hh.rh;r:=s;p:=7999997;m:=0;end;
{392:}22:get_token;
...
end;back_error;end;pstack[n]:=mem[7999997].hh.rh;
...
rbrace_ptr].hh.rh:=0;begin mem[p].hh.rh:=avail;avail:=p;
{dyn_used:=dyn_used-1;}end;p:=mem[7999997].hh.rh;
pstack[n]:=mem[p].hh.rh;begin mem[p].hh.rh:=avail;avail:=p;
{dyn_used:=dyn_used-1;}end;end else pstack[n]:=mem[7999997].hh.rh;
n:=n+1;if eqtb[603193].int>0 then begin begin_diagnostic;
...
back_input;cur_tok:=604616;back_input;cur_input.index_field:=4;end;
...
co_backup:=cur_order;backup_backup:=mem[7999987].hh.rh;
if cur_cmd<111 then{367:}begin if eqtb[603199].int>1 then
show_cur_cmd_chr;
...
mem[p].hh.lh:=604618;mem[p].hh.rh:=cur_input.loc_field;
...
begin begin if interaction=3 then;print_nl(262);print(777);end;
print_cmd_chr(106,cur_chr);begin help_ptr:=1;help_line[0]:=778;end;
...
604615;back_input;end{:375};cur_val:=cv_backup;
cur_val_level:=cvl_backup;radix:=radix_backup;cur_order:=co_backup;
mem[7999987].hh.rh:=backup_backup;end;{:366}{380:}procedure get_x_token;
...
600520;cur_cmd:=9;goto 30;end else expand;goto 20;
...
var p:halfword;q:halfword;k:pool_pointer;begin p:=7999987;
...
k:=k+1;end else if(cur_cmd<>10)or(p<>7999987)then begin back_input;
if p<>7999987 then begin_token_list(mem[7999987].hh.rh,3);
scan_keyword:=false;goto 10;end;end;flush_list(mem[7999987].hh.rh);
...
if cur_cmd=88 then f:=eqtb[601834].hh.rh else if cur_cmd=87 then f:=
...
print_nl(262);print(817);end;begin help_ptr:=2;help_line[1]:=818;
help_line[0]:=819;end;back_error;f:=0;end;cur_val:=f;end;
...
begin repeat if fmem_ptr=font_mem_size then overflow(824,font_mem_size);
...
print_nl(262);print(802);end;print_esc(hash[600524+f].rh);print(820);
print_int(font_params[f]);print(821);begin help_ptr:=2;
help_line[1]:=822;help_line[0]:=823;end;error;end{:579};end;
...
if m=602907 then begin cur_val:=eqtb[602907+cur_val].hh.rh-0;
cur_val_level:=0;
end else if m<602907 then begin cur_val:=eqtb[m+cur_val].hh.rh;
...
scan_eight_bit_int;m:=601322+cur_val;end;begin cur_val:=eqtb[m].hh.rh;
cur_val_level:=5;end;end else begin back_input;scan_font_ident;
begin cur_val:=600524+cur_val;cur_val_level:=4;end;end{:415};
...
84:{423:}begin if eqtb[601312].hh.rh=0 then cur_val:=0 else cur_val:=mem
[eqtb[601312].hh.rh].hh.lh;cur_val_level:=0;end{:423};
83:{420:}begin scan_eight_bit_int;
if eqtb[601578+cur_val].hh.rh=0 then cur_val:=0 else cur_val:=mem[eqtb[
601578+cur_val].hh.rh+m].int;cur_val_level:=1;end{:420};
...
case m of 0:cur_val:=eqtb[603218+cur_val].int;
1:cur_val:=eqtb[603751+cur_val].int;
2:cur_val:=eqtb[600800+cur_val].hh.rh;
3:cur_val:=eqtb[601056+cur_val].hh.rh;end;cur_val_level:=m;end{:427};
...
if mu then goto 45;
if scan_keyword(708)then v:=({558:}font_info[6+param_base[eqtb[601834].
hh.rh]].int{:558})else if scan_keyword(709)then v:=({559:}font_info[5+
param_base[eqtb[601834].hh.rh]].int{:559})else goto 45;
...
if eqtb[603180].int<>1000 then begin cur_val:=xn_over_d(cur_val,1000,
eqtb[603180].int);f:=(1000*f+65536*remainder)div eqtb[603180].int;
...
init_pool_ptr);end;p:=7999997;mem[p].hh.rh:=0;k:=b;
...
if cur_val_level>=4 then{466:}begin p:=7999997;mem[p].hh.rh:=0;
...
{:465}{467:}procedure ins_the_toks;begin mem[7999988].hh.rh:=the_toks;
begin_token_list(mem[7999997].hh.rh,4);end;
...
end{:472};selector:=old_setting;mem[7999988].hh.rh:=str_toks(b);
begin_token_list(mem[7999997].hh.rh,4);end;
...
if macro_def then{474:}begin while true do begin 22:get_token;
if cur_tok<768 then goto 31;
if cur_cmd=6 then{476:}begin s:=3328+cur_chr;get_token;
if cur_tok<512 then begin hash_brace:=cur_tok;begin q:=get_avail;
...
print(744);end;begin help_ptr:=2;help_line[1]:=745;help_line[0]:=746;
end;error;goto 22;end else begin t:=t+1;
if cur_tok<>t then begin begin if interaction=3 then;print_nl(262);
print(747);end;begin help_ptr:=2;help_line[1]:=748;help_line[0]:=749;
...
if mem[7999997].hh.rh<>0 then begin mem[p].hh.rh:=mem[7999997].hh.rh;
...
interaction=3 then;print_nl(262);print(750);end;
sprint_cs(warning_index);begin help_ptr:=3;help_line[2]:=751;
help_line[1]:=752;help_line[0]:=753;end;back_error;cur_tok:=s;
...
end else fatal_error(754){:484}else if read_open[m]=1 then{485:}if
...
print_nl(262);print(755);end;print_esc(534);begin help_ptr:=1;
help_line[0]:=756;end;align_state:=1000000;cur_input.limit_field:=0;
error;end;end;end{:486};cur_input.limit_field:=last;
if(eqtb[603211].int<0)or(eqtb[603211].int>255)then cur_input.limit_field
:=cur_input.limit_field-1 else buffer[cur_input.limit_field]:=eqtb[
603211].int;first:=cur_input.limit_field+1;
...
if interaction=3 then;print_nl(262);print(781);end;
print_cmd_chr(105,this_if);begin help_ptr:=1;help_line[0]:=782;end;
back_error;r:=61;end;
...
9,10,11:{505:}begin scan_eight_bit_int;p:=eqtb[601578+cur_val].hh.rh;
...
if eqtb[603199].int>1 then begin begin_diagnostic;print(783);
...
if eqtb[603199].int>1 then{502:}begin begin_diagnostic;
if b then print(779)else print(780);end_diagnostic(false);end{:502};
...
begin if interaction=3 then;print_nl(262);print(777);end;print_esc(775);
begin help_ptr:=1;help_line[0]:=778;end;error;
...
if s=787 then begin if interaction=3 then;print_nl(262);print(788);
end else begin if interaction=3 then;print_nl(262);print(789);end;
print_file_name(cur_name,cur_area,cur_ext);print(790);
if e=791 then show_context;print_nl(792);print(s);
if interaction<2 then fatal_error(793);break_in(term_in,true);begin;
...
begin old_setting:=selector;if job_name=0 then job_name:=796;
pack_job_name(797);
while not a_open_out(log_file)do{535:}begin selector:=17;
prompt_file_name(799,797);end{:535};
log_name:=a_make_name_string(log_file);selector:=18;log_opened:=true;
{536:}begin write(log_file,'This is TeX, Version 3.141592653');
slow_print(format_ident);print(800);print_int(sys_day);print_char(32);
...
end{:536};input_stack[input_ptr]:=cur_input;print_nl(798);
l:=input_stack[0].limit_field;if buffer[l]=eqtb[603211].int then l:=l-1;
...
if aire=338 then pack_file_name(nom,785,811)else pack_file_name(nom,aire
,811);if not b_open_in(tfm_file)then goto 11;file_opened:=true{:563};
...
if interaction=3 then;print_nl(262);print(802);end;sprint_cs(u);
print_char(61);print_file_name(nom,aire,338);
if s>=0 then begin print(741);print_scaled(s);print(397);
end else if s<>-1000 then begin print(803);print_int(-s);end;print(812);
begin help_ptr:=4;help_line[3]:=813;help_line[2]:=814;help_line[1]:=815;
help_line[0]:=816;end;error;goto 30;end{:567};f:=font_ptr+1;
...
hyphen_char[f]:=eqtb[603209].int;skew_char[f]:=eqtb[603210].int;
...
print(802);end;sprint_cs(u);print_char(61);
print_file_name(nom,aire,338);if s>=0 then begin print(741);
print_scaled(s);print(397);end else if s<>-1000 then begin print(803);
print_int(-s);end;if file_opened then print(804)else print(805);
begin help_ptr:=5;help_line[4]:=806;help_line[3]:=807;help_line[2]:=808;
help_line[1]:=809;help_line[0]:=810;end;error{:561};
...
begin if eqtb[603198].int>0 then begin begin_diagnostic;print_nl(825);
print(c);print(826);slow_print(font_name[f]);print_char(33);
...
mem[q].hh.lh:=637;r:=get_avail;mem[q].hh.rh:=r;mem[r].hh.lh:=604617;
...
get_token;
if cur_tok<>604617 then{1372:}begin begin if interaction=3 then;
print_nl(262);print(1297);end;begin help_ptr:=2;help_line[1]:=1298;
help_line[0]:=1012;end;error;repeat get_token;until cur_tok=604617;
...
cur_ext:=mem[p+2].hh.rh;if cur_ext=338 then cur_ext:=791;
pack_file_name(cur_name,cur_area,cur_ext);
while not a_open_out(write_file[j])do prompt_file_name(1300,791);
write_open[j]:=true;end;end;end{:1374};3:special_out(p);4:;
others:confusion(1299)end;end;{:1373}procedure hlist_out;
...
6:{652:}begin mem[7999988]:=mem[p+1];mem[7999988].hh.rh:=mem[p].hh.rh;
p:=7999988;goto 21;end{:652};others:end;goto 15;
...
while p<>0 do{630:}begin if(p>=hi_mem_min)then confusion(828)else{631:}
...
begin if eqtb[603197].int>0 then begin print_nl(338);print_ln;
print(829);end;
if term_offset>max_print_line-9 then print_ln else if(term_offset>0)or(
file_offset>0)then print_char(32);print_char(91);j:=9;
while(eqtb[603218+j].int=0)and(j>0)do j:=j-1;
for k:=0 to j do begin print_int(eqtb[603218+k].int);
if k<j then print_char(46);end;break(term_out);
if eqtb[603197].int>0 then begin print_char(93);begin_diagnostic;
show_box(p);end_diagnostic(true);end;
{640:}{641:}if(mem[p+3].int>1073741823)or(mem[p+2].int>1073741823)or(mem
[p+3].int+mem[p+2].int+eqtb[603749].int>1073741823)or(mem[p+1].int+eqtb[
603748].int>1073741823)then begin begin if interaction=3 then;
print_nl(262);print(833);end;begin help_ptr:=2;help_line[1]:=834;
help_line[0]:=835;end;error;
if eqtb[603197].int<=0 then begin begin_diagnostic;print_nl(836);
show_box(p);end_diagnostic(true);end;goto 30;end;
if mem[p+3].int+mem[p+2].int+eqtb[603749].int>max_v then max_v:=mem[p+3]
.int+mem[p+2].int+eqtb[603749].int;
if mem[p+1].int+eqtb[603748].int>max_h then max_h:=mem[p+1].int+eqtb[
603748].int{:641};{617:}dvi_h:=0;dvi_v:=0;cur_h:=eqtb[603748].int;
dvi_f:=0;
if output_file_name=0 then begin if job_name=0 then open_log_file;
pack_job_name(794);
while not b_open_out(dvi_file)do prompt_file_name(795,794);
...
dvi_four(473628672);prepare_mag;dvi_four(eqtb[603180].int);
old_setting:=selector;selector:=21;print(827);
print_int(eqtb[603186].int);print_char(46);print_two(eqtb[603185].int);
print_char(46);print_two(eqtb[603184].int);print_char(58);
print_two(eqtb[603183].int div 60);print_two(eqtb[603183].int mod 60);
selector:=old_setting;
begin dvi_buf[dvi_ptr]:=(pool_ptr-str_start[str_ptr]);
dvi_ptr:=dvi_ptr+1;if dvi_ptr=dvi_limit then dvi_swap;end;
...
if dvi_ptr=dvi_limit then dvi_swap;end;
for k:=0 to 9 do dvi_four(eqtb[603218+k].int);dvi_four(last_bop);
last_bop:=page_loc;cur_v:=mem[p+3].int+eqtb[603749].int;temp_ptr:=p;
...
cur_s:=-1;30:{:640};if eqtb[603197].int<=0 then print_char(93);
dead_cycles:=0;break(term_out);
{639:}{if eqtb[603194].int>1 then begin print_nl(830);
print_int(var_used);print_char(38);print_int(dyn_used);print_char(59);
end;}flush_node_list(p);{if eqtb[603194].int>1 then begin print(831);
print_int(var_used);print_char(38);print_int(dyn_used);print(832);
...
if scan_keyword(842)then spec_code:=0 else if scan_keyword(843)then
...
11,9:x:=x+mem[p+1].int;6:{652:}begin mem[7999988]:=mem[p+1];
mem[7999988].hh.rh:=mem[p].hh.rh;p:=7999988;goto 21;end{:652};
...
,total_stretch[0]);if last_badness>eqtb[603189].int then begin print_ln;
if last_badness>100 then print_nl(844)else print_nl(845);print(846);
...
{666:}if(-x-total_shrink[0]>eqtb[603738].int)or(eqtb[603189].int<100)
then begin if(eqtb[603746].int>0)and(-x-total_shrink[0]>eqtb[603738].int
)then begin while mem[q].hh.rh<>0 do q:=mem[q].hh.rh;
mem[q].hh.rh:=new_rule;mem[mem[q].hh.rh+1].int:=eqtb[603746].int;end;
print_ln;print_nl(852);print_scaled(-x-total_shrink[0]);print(853);
goto 50;end{:666};
end else if o=0 then if mem[r+5].hh.rh<>0 then{667:}begin last_badness:=
badness(-x,total_shrink[0]);
if last_badness>eqtb[603189].int then begin print_ln;print_nl(854);
print_int(last_badness);goto 50;end;end{:667};goto 10;end{:664}{:657};
50:{663:}if output_active then print(847)else begin if pack_begin_line<>
0 then begin if pack_begin_line>0 then print(848)else print(849);
print_int(abs(pack_begin_line));print(850);end else print(851);
...
while p<>0 do{669:}begin if(p>=hi_mem_min)then confusion(855)else case
...
,total_stretch[0]);if last_badness>eqtb[603190].int then begin print_ln;
if last_badness>100 then print_nl(844)else print_nl(845);print(856);
...
if(total_shrink[o]<-x)and(o=0)and(mem[r+5].hh.rh<>0)then begin
last_badness:=1000000;mem[r+6].gr:=1.0;
{677:}if(-x-total_shrink[0]>eqtb[603739].int)or(eqtb[603190].int<100)
then begin print_ln;print_nl(857);print_scaled(-x-total_shrink[0]);
print(858);goto 50;end{:677};
end else if o=0 then if mem[r+5].hh.rh<>0 then{678:}begin last_badness:=
badness(-x,total_shrink[0]);
if last_badness>eqtb[603190].int then begin print_ln;print_nl(859);
print_int(last_badness);goto 50;end;end{:678};goto 10;end{:676}{:672};
50:{675:}if output_active then print(847)else begin if pack_begin_line<>
0 then begin print(849);print_int(abs(pack_begin_line));print(850);
end else print(851);print_int(line);print_ln;end;begin_diagnostic;
show_box(r);end_diagnostic(true){:675};10:vpackage:=r;end;
{:668}{679:}procedure append_to_vlist(b:halfword);var d:scaled;
p:halfword;
begin if cur_list.aux_field.int>-65536000 then begin d:=mem[eqtb[600783]
.hh.rh+1].int-cur_list.aux_field.int-mem[b+3].int;
if d<eqtb[603732].int then p:=new_param_glue(0)else begin p:=
...
repeat z:=z-16;g:=eqtb[601835+z].hh.rh;if g<>0 then{708:}begin y:=x;
...
mem[b+1].int:=eqtb[603741].int;end;
mem[b+4].int:=half(mem[b+3].int-mem[b+2].int)-font_info[22+param_base[
eqtb[601837+s].hh.rh]].int;var_delimiter:=b;end;
...
mlist_to_hlist;q:=mem[7999997].hh.rh;cur_style:=save_style;
{703:}begin if cur_style<4 then cur_size:=0 else cur_size:=16*((
cur_style-2)div 2);
cur_mu:=x_over_n(font_info[6+param_base[eqtb[601837+cur_size].hh.rh]].
int,18);end{:703};
...
begin cur_c:=mem[a].hh.b1;
cur_f:=eqtb[601835+mem[a].hh.b0+cur_size].hh.rh;
if cur_f=0 then{723:}begin begin if interaction=3 then;print_nl(262);
print(338);end;print_size(cur_size);print_char(32);
print_int(mem[a].hh.b0);print(884);print(cur_c-0);print_char(41);
begin help_ptr:=4;help_line[3]:=885;help_line[2]:=886;help_line[1]:=887;
help_line[0]:=888;end;error;cur_i:=null_character;mem[a].hh.rh:=0;
...
mem[a].hh.rh:=0;cur_i:=null_character;end;end;end;
{:722}{726:}{734:}procedure make_over(q:halfword);
begin mem[q+1].hh.lh:=overbar(clean_box(q+1,2*(cur_style div 2)+1),3*
font_info[8+param_base[eqtb[601838+cur_size].hh.rh]].int,font_info[8+
param_base[eqtb[601838+cur_size].hh.rh]].int);mem[q+1].hh.rh:=2;end;
{:734}{735:}procedure make_under(q:halfword);var p,x,y:halfword;
delta:scaled;begin x:=clean_box(q+1,cur_style);
p:=new_kern(3*font_info[8+param_base[eqtb[601838+cur_size].hh.rh]].int);
mem[x].hh.rh:=p;
mem[p].hh.rh:=fraction_rule(font_info[8+param_base[eqtb[601838+cur_size]
.hh.rh]].int);y:=vpackage(x,0,1,1073741823);
delta:=mem[y+3].int+mem[y+2].int+font_info[8+param_base[eqtb[601838+
...
mem[v+3].int:=font_info[22+param_base[eqtb[601837+cur_size].hh.rh]].int+
...
if cur_style<2 then clr:=font_info[8+param_base[eqtb[601838+cur_size].hh
.rh]].int+(abs(font_info[5+param_base[eqtb[601837+cur_size].hh.rh]].int)
div 4)else begin clr:=font_info[8+param_base[eqtb[601838+cur_size].hh.rh
]].int;clr:=clr+(abs(clr)div 4);end;
y:=var_delimiter(q+4,cur_size,mem[x+3].int+mem[x+2].int+clr+font_info[8+
param_base[eqtb[601838+cur_size].hh.rh]].int);
...
z,mem[x+1].int);
if cur_style<2 then begin shift_up:=font_info[8+param_base[eqtb[601837+
cur_size].hh.rh]].int;
shift_down:=font_info[11+param_base[eqtb[601837+cur_size].hh.rh]].int;
end else begin shift_down:=font_info[12+param_base[eqtb[601837+cur_size]
.hh.rh]].int;
if mem[q+1].int<>0 then shift_up:=font_info[9+param_base[eqtb[601837+
cur_size].hh.rh]].int else shift_up:=font_info[10+param_base[eqtb[
601837+cur_size].hh.rh]].int;end{:744};
if mem[q+1].int=0 then{745:}begin if cur_style<2 then clr:=7*font_info[
8+param_base[eqtb[601838+cur_size].hh.rh]].int else clr:=3*font_info[8+
param_base[eqtb[601838+cur_size].hh.rh]].int;
...
601837+cur_size].hh.rh]].int+delta));
delta2:=clr-((font_info[22+param_base[eqtb[601837+cur_size].hh.rh]].int-
...
p:=new_kern((font_info[22+param_base[eqtb[601837+cur_size].hh.rh]].int-
delta)-(mem[z+3].int-shift_down));mem[y].hh.rh:=p;mem[p].hh.rh:=z;
p:=new_kern((shift_up-mem[x+2].int)-(font_info[22+param_base[eqtb[
601837+cur_size].hh.rh]].int+delta));mem[p].hh.rh:=y;end;
mem[x].hh.rh:=p;mem[v+5].hh.rh:=x{:747};
{748:}if cur_style<2 then delta:=font_info[20+param_base[eqtb[601837+
cur_size].hh.rh]].int else delta:=font_info[21+param_base[eqtb[601837+
...
eqtb[601837+cur_size].hh.rh]].int;mem[q+1].hh.rh:=2;mem[q+1].hh.lh:=x;
end else delta:=0;
...
end else begin shift_up:=font_info[11+param_base[eqtb[601838+cur_size].
hh.rh]].int-mem[x+2].int;
if shift_up<font_info[9+param_base[eqtb[601838+cur_size].hh.rh]].int
then shift_up:=font_info[9+param_base[eqtb[601838+cur_size].hh.rh]].int;
p:=new_kern(shift_up);mem[p].hh.rh:=y;mem[x].hh.rh:=p;
p:=new_kern(font_info[13+param_base[eqtb[601838+cur_size].hh.rh]].int);
mem[p].hh.rh:=x;mem[v+5].hh.rh:=p;
mem[v+3].int:=mem[v+3].int+font_info[13+param_base[eqtb[601838+cur_size]
.hh.rh]].int+mem[x+3].int+mem[x+2].int+shift_up;end;
if mem[q+3].hh.rh=0 then free_node(z,7)else begin shift_down:=font_info[
12+param_base[eqtb[601838+cur_size].hh.rh]].int-mem[z+3].int;
if shift_down<font_info[10+param_base[eqtb[601838+cur_size].hh.rh]].int
then shift_down:=font_info[10+param_base[eqtb[601838+cur_size].hh.rh]].
int;p:=new_kern(shift_down);mem[y].hh.rh:=p;mem[p].hh.rh:=z;
p:=new_kern(font_info[13+param_base[eqtb[601838+cur_size].hh.rh]].int);
mem[z].hh.rh:=p;
mem[v+2].int:=mem[v+2].int+font_info[13+param_base[eqtb[601838+cur_size]
...
shift_up:=mem[z+3].int-font_info[18+param_base[eqtb[601837+t].hh.rh]].
int;
shift_down:=mem[z+2].int+font_info[19+param_base[eqtb[601837+t].hh.rh]].
int;free_node(z,7);end;
if mem[q+2].hh.rh=0 then{757:}begin x:=clean_box(q+3,2*(cur_style div 4)
+5);mem[x+1].int:=mem[x+1].int+eqtb[603742].int;
if shift_down<font_info[16+param_base[eqtb[601837+cur_size].hh.rh]].int
then shift_down:=font_info[16+param_base[eqtb[601837+cur_size].hh.rh]].
int;
clr:=mem[x+3].int-(abs(font_info[5+param_base[eqtb[601837+cur_size].hh.
rh]].int*4)div 5);if shift_down<clr then shift_down:=clr;
mem[x+4].int:=shift_down;
end{:757}else begin{758:}begin x:=clean_box(q+2,2*(cur_style div 4)+4+(
cur_style mod 2));mem[x+1].int:=mem[x+1].int+eqtb[603742].int;
if odd(cur_style)then clr:=font_info[15+param_base[eqtb[601837+cur_size]
.hh.rh]].int else if cur_style<2 then clr:=font_info[13+param_base[eqtb[
601837+cur_size].hh.rh]].int else clr:=font_info[14+param_base[eqtb[
601837+cur_size].hh.rh]].int;if shift_up<clr then shift_up:=clr;
clr:=mem[x+2].int+(abs(font_info[5+param_base[eqtb[601837+cur_size].hh.
rh]].int)div 4);if shift_up<clr then shift_up:=clr;end{:758};
if mem[q+3].hh.rh=0 then mem[x+4].int:=-shift_up else{759:}begin y:=
clean_box(q+3,2*(cur_style div 4)+5);
mem[y+1].int:=mem[y+1].int+eqtb[603742].int;
if shift_down<font_info[17+param_base[eqtb[601837+cur_size].hh.rh]].int
then shift_down:=font_info[17+param_base[eqtb[601837+cur_size].hh.rh]].
int;clr:=4*font_info[8+param_base[eqtb[601838+cur_size].hh.rh]].int-((
shift_up-mem[x+2].int)-(mem[y+3].int-shift_down));
if clr>0 then begin shift_down:=shift_down+clr;
clr:=(abs(font_info[5+param_base[eqtb[601837+cur_size].hh.rh]].int*4)div
...
delta2:=max_d+font_info[22+param_base[eqtb[601837+cur_size].hh.rh]].int;
delta1:=max_h+max_d-delta2;if delta2>delta1 then delta1:=delta2;
delta:=(delta1 div 500)*eqtb[603181].int;
delta2:=delta1+delta1-eqtb[603740].int;
...
cur_style-2)div 2);
cur_mu:=x_over_n(font_info[6+param_base[eqtb[601837+cur_size].hh.rh]].
int,18);end{:703};while q<>0 do{727:}begin{728:}21:delta:=0;
...
cur_style-2)div 2);
cur_mu:=x_over_n(font_info[6+param_base[eqtb[601837+cur_size].hh.rh]].
int,18);end{:703};p:=hpack(mem[7999997].hh.rh,0,1);end;
others:confusion(890)end;mem[q+1].int:=p;
...
{729:}if r_type=18 then mem[r].hh.b0:=16{:729};{760:}p:=7999997;
mem[p].hh.rh:=0;q:=mlist;r_type:=0;cur_style:=style;
{703:}begin if cur_style<4 then cur_size:=0 else cur_size:=16*((
cur_style-2)div 2);
cur_mu:=x_over_n(font_info[6+param_base[eqtb[601837+cur_size].hh.rh]].
int,18);end{:703};while q<>0 do begin{761:}t:=16;s:=4;pen:=10000;
case mem[q].hh.b0 of 17,20,21,22,23:t:=mem[q].hh.b0;18:begin t:=18;
pen:=eqtb[603172].int;end;19:begin t:=19;pen:=eqtb[603173].int;end;
...
cur_style-2)div 2);
cur_mu:=x_over_n(font_info[6+param_base[eqtb[601837+cur_size].hh.rh]].
int,18);end{:703};goto 83;end{:763};
8,12,2,7,5,3,4,10,11:begin mem[p].hh.rh:=q;p:=q;q:=mem[q].hh.rh;
mem[p].hh.rh:=0;goto 30;end;others:confusion(891)end{:761};
...
52:if cur_style<4 then x:=17 else x:=0;others:confusion(893)end;
if x<>0 then begin y:=math_glue(eqtb[600782+x].hh.rh,cur_mu);
...
mem[p].hh.lh:=cur_align;mem[p+1].hh.lh:=mem[7999992].hh.rh;
...
mem[7999992].hh.rh:=mem[p+1].hh.lh;cur_align:=mem[p].hh.lh;
...
if(cur_cmd=75)and(cur_chr=600793)then begin scan_optional_equals;
scan_glue(2);
if eqtb[603206].int>0 then geq_define(600793,117,cur_val)else eq_define(
600793,117,cur_val);goto 20;end;end;{:782}procedure align_peek;forward;
...
=3 then;print_nl(262);print(680);end;print_esc(520);print(894);
begin help_ptr:=3;help_line[2]:=895;help_line[1]:=896;help_line[0]:=897;
...
mode_field{:775};scan_spec(6,false);{777:}mem[7999992].hh.rh:=0;
cur_align:=7999992;cur_loop:=0;scanner_status:=4;
...
{779:}{783:}p:=7999996;mem[p].hh.rh:=0;
while true do begin get_preamble_token;if cur_cmd=6 then goto 31;
if(cur_cmd<=5)and(cur_cmd>=4)and(align_state=-1000000)then if(p=7999996)
and(cur_loop=0)and(cur_cmd=4)then cur_loop:=cur_align else begin begin
if interaction=3 then;print_nl(262);print(903);end;begin help_ptr:=3;
help_line[2]:=904;help_line[1]:=905;help_line[0]:=906;end;back_error;
goto 31;
end else if(cur_cmd<>10)or(p<>7999996)then begin mem[p].hh.rh:=get_avail
;p:=mem[p].hh.rh;mem[p].hh.lh:=cur_tok;end;end;31:{:783};
mem[cur_align].hh.rh:=new_null_box;cur_align:=mem[cur_align].hh.rh;
mem[cur_align].hh.lh:=7999991;mem[cur_align+1].int:=-1073741824;
mem[cur_align+3].int:=mem[7999996].hh.rh;{784:}p:=7999996;
...
print(907);end;begin help_ptr:=3;help_line[2]:=904;help_line[1]:=905;
help_line[0]:=908;end;error;goto 22;end;mem[p].hh.rh:=get_avail;
p:=mem[p].hh.rh;mem[p].hh.lh:=cur_tok;end;32:mem[p].hh.rh:=get_avail;
p:=mem[p].hh.rh;mem[p].hh.lh:=604614{:784};
mem[cur_align+2].int:=mem[7999996].hh.rh{:779};end;
30:scanner_status:=0{:777};new_save_level(6);
if eqtb[601320].hh.rh<>0 then begin_token_list(eqtb[601320].hh.rh,13);
...
begin mem[cur_list.tail_field].hh.rh:=new_glue(mem[mem[7999992].hh.rh+1]
.hh.lh);cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
mem[cur_list.tail_field].hh.b1:=12;
cur_align:=mem[mem[7999992].hh.rh].hh.rh;cur_tail:=cur_head;
...
begin if cur_align=0 then confusion(909);q:=mem[cur_align].hh.rh;
if q=0 then confusion(909);if align_state<500000 then fatal_error(595);
p:=mem[q].hh.rh;
{792:}if(p=0)and(mem[cur_align+5].hh.lh<257)then if cur_loop<>0 then
{793:}begin mem[q].hh.rh:=new_null_box;p:=mem[q].hh.rh;
mem[p].hh.lh:=7999991;mem[p+1].int:=-1073741824;
cur_loop:=mem[cur_loop].hh.rh;{794:}q:=7999996;r:=mem[cur_loop+3].int;
while r<>0 do begin mem[q].hh.rh:=get_avail;q:=mem[q].hh.rh;
mem[q].hh.lh:=mem[r].hh.lh;r:=mem[r].hh.rh;end;mem[q].hh.rh:=0;
mem[p+3].int:=mem[7999996].hh.rh;q:=7999996;r:=mem[cur_loop+2].int;
while r<>0 do begin mem[q].hh.rh:=get_avail;q:=mem[q].hh.rh;
mem[q].hh.lh:=mem[r].hh.lh;r:=mem[r].hh.rh;end;mem[q].hh.rh:=0;
mem[p+2].int:=mem[7999996].hh.rh{:794};cur_loop:=mem[cur_loop].hh.rh;
...
print(910);end;print_esc(899);begin help_ptr:=3;help_line[2]:=911;
help_line[1]:=912;help_line[0]:=913;end;mem[cur_align+5].hh.lh:=257;
...
if n>255 then confusion(914);q:=cur_span;
...
begin if cur_group<>6 then confusion(915);unsave;
if cur_group<>6 then confusion(916);unsave;
if nest[nest_ptr-1].mode_field=203 then o:=eqtb[603745].int else o:=0;
{801:}q:=mem[mem[7999992].hh.rh].hh.rh;repeat flush_list(mem[q+3].int);
...
if mem[q].hh.lh<>7999991 then{803:}begin t:=mem[q+1].int+mem[mem[mem[q].
hh.rh+1].hh.lh+1].int;r:=mem[q].hh.lh;s:=7999991;mem[s].hh.lh:=p;n:=1;
...
hh.lh+1].int:=mem[r+1].int;free_node(r,2);end;r:=u;until r=7999991;
...
if cur_list.mode_field=-1 then begin rule_save:=eqtb[603746].int;
eqtb[603746].int:=0;
p:=hpack(mem[7999992].hh.rh,save_stack[save_ptr+1].int,save_stack[
save_ptr+0].int);eqtb[603746].int:=rule_save;
end else begin q:=mem[mem[7999992].hh.rh].hh.rh;
repeat mem[q+3].int:=mem[q+1].int;mem[q+1].int:=0;
q:=mem[mem[q].hh.rh].hh.rh;until q=0;
p:=vpackage(mem[7999992].hh.rh,save_stack[save_ptr+1].int,save_stack[
save_ptr+0].int,1073741823);q:=mem[mem[7999992].hh.rh].hh.rh;
...
repeat{808:}n:=mem[r].hh.b1;t:=mem[s+1].int;w:=t;u:=7999996;
...
mem[r+4].int:=0;if u<>7999996 then begin mem[u].hh.rh:=mem[r].hh.rh;
mem[r].hh.rh:=mem[7999996].hh.rh;r:=u;end{:808};
...
print_nl(262);print(1170);end;begin help_ptr:=2;help_line[1]:=895;
help_line[0]:=896;end;back_error;end{:1207}else{1197:}begin get_x_token;
if cur_cmd<>3 then begin begin if interaction=3 then;print_nl(262);
print(1166);end;begin help_ptr:=2;help_line[1]:=1167;help_line[0]:=1168;
end;back_error;end;end{:1197};pop_nest;
begin mem[cur_list.tail_field].hh.rh:=new_penalty(eqtb[603174].int);
...
begin mem[cur_list.tail_field].hh.rh:=new_penalty(eqtb[603175].int);
cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
...
{if eqtb[603195].int>0 then end_diagnostic(true);}
begin if interaction=3 then;print_nl(262);print(917);end;
begin help_ptr:=5;help_line[4]:=918;help_line[3]:=919;help_line[2]:=920;
help_line[1]:=921;help_line[0]:=922;end;error;
{if eqtb[603195].int>0 then begin_diagnostic;}end;q:=new_spec(p);
...
-10000{:831};no_break_yet:=true;prev_r:=7999993;old_l:=0;
...
easy_line)or(r=7999993))then{836:}begin if no_break_yet then{837:}begin
...
others:confusion(923)end{:841};end;
...
others:confusion(924)end{:842};s:=mem[s].hh.rh;end;
...
end else if prev_r=7999993 then begin active_width[1]:=break_width[1];
...
if abs(eqtb[603179].int)>=1073741823-minimum_demerits then
...
{if eqtb[603195].int>0 then[846:]begin print_nl(925);
print_int(mem[passive].hh.lh);print(926);print_int(mem[q+1].hh.lh-1);
print_char(46);print_int(fit_class);if break_type=1 then print_char(45);
print(927);print_int(mem[q+2].int);print(928);
...
{844:}if r<>7999993 then begin q:=get_node(7);mem[q].hh.rh:=r;
...
if r=7999993 then goto 10;
{850:}if l>easy_line then begin line_width:=second_width;old_l:=65534;
end else begin old_l:=l;
if l>last_special_line then line_width:=second_width else if eqtb[601312
].hh.rh=0 then line_width:=first_width else line_width:=mem[eqtb[601312]
.hh.rh+2*l].int;end{:850};end;end{:835};
...
minimum_demerits=1073741823)and(mem[r].hh.rh=7999993)and(prev_r=7999993)
then artificial_demerits:=true else if b>threshold then goto 60;
node_r_stays_active:=false;end{:854}else begin prev_r:=r;
if b>threshold then goto 22;node_r_stays_active:=true;end;
{855:}if artificial_demerits then d:=0 else{859:}begin d:=eqtb[603165].
int+b;if abs(d)>=10000 then d:=100000000 else d:=d*d;
if pi<>0 then if pi>0 then d:=d+pi*pi else if pi>-10000 then d:=d-pi*pi;
if(break_type=1)and(mem[r].hh.b0=1)then if cur_p<>0 then d:=d+eqtb[
603177].int else d:=d+eqtb[603178].int;
if abs(fit_class-mem[r].hh.b1)>1 then d:=d+eqtb[603179].int;end{:859};
{if eqtb[603195].int>0 then[856:]begin if printed_node<>cur_p then[857:]
begin print_nl(338);
...
print_esc(343);end;print(929);
if mem[r+1].hh.rh=0 then print_char(48)else print_int(mem[mem[r+1].hh.rh
].hh.lh);print(930);if b>10000 then print_char(42)else print_int(b);
print(931);print_int(pi);print(932);
...
if prev_r=7999993 then{861:}begin r:=mem[7999993].hh.rh;
...
cur_active_width[4]:=active_width[4];
cur_active_width[5]:=active_width[5];
cur_active_width[6]:=active_width[6];mem[7999993].hh.rh:=mem[r].hh.rh;
free_node(r,7);end;
end{:861}else if mem[prev_r].hh.b0=2 then begin r:=mem[prev_r].hh.rh;
if r=7999993 then begin cur_active_width[1]:=cur_active_width[1]-mem[
prev_r+1].int;
...
mem[prev_prev_r].hh.rh:=7999993;free_node(prev_r,7);prev_r:=prev_prev_r;
...
lh);mem[q+1].hh.lh:=eqtb[600790].hh.rh;mem[q].hh.b1:=9;
mem[eqtb[600790].hh.rh].hh.rh:=mem[eqtb[600790].hh.rh].hh.rh+1;goto 30;
...
end else begin q:=7999997;while mem[q].hh.rh<>0 do q:=mem[q].hh.rh;end;
{886:}r:=new_param_glue(8);mem[r].hh.rh:=mem[q].hh.rh;mem[q].hh.rh:=r;
q:=r{:886};30:{:881};{887:}r:=mem[q].hh.rh;mem[q].hh.rh:=0;
q:=mem[7999997].hh.rh;mem[7999997].hh.rh:=r;
if eqtb[600789].hh.rh<>0 then begin r:=new_param_glue(7);
mem[r].hh.rh:=q;q:=r;end{:887};
{889:}if cur_line>last_special_line then begin cur_width:=second_width;
cur_indent:=second_indent;
end else if eqtb[601312].hh.rh=0 then begin cur_width:=first_width;
cur_indent:=first_indent;
end else begin cur_width:=mem[eqtb[601312].hh.rh+2*cur_line].int;
cur_indent:=mem[eqtb[601312].hh.rh+2*cur_line-1].int;end;
adjust_tail:=7999995;just_box:=hpack(q,cur_width,0);
mem[just_box+4].int:=cur_indent{:889};{888:}append_to_vlist(just_box);
if 7999995<>adjust_tail then begin mem[cur_list.tail_field].hh.rh:=mem[
7999995].hh.rh;cur_list.tail_field:=adjust_tail;end;
adjust_tail:=0{:888};
{890:}if cur_line+1<>best_line then begin pen:=eqtb[603176].int;
if cur_line=cur_list.pg_field+1 then pen:=pen+eqtb[603168].int;
if cur_line+2=best_line then pen:=pen+final_widow_penalty;
if disc_break then pen:=pen+eqtb[603171].int;
...
if cur_p<>0 then if not post_disc_break then{879:}begin r:=7999997;
...
31:if r<>7999997 then begin mem[r].hh.rh:=0;
flush_node_list(mem[7999997].hh.rh);mem[7999997].hh.rh:=q;end;end{:879};
until cur_p=0;
if(cur_line<>best_line)or(mem[7999997].hh.rh<>0)then confusion(939);
...
k:font_index;begin hyphen_passed:=0;t:=7999996;w:=0;
mem[7999996].hh.rh:=0;{908:}cur_l:=hu[j]+0;cur_q:=t;
...
hc[hn]:=cur_lang;for j:=2 to hn do h:=(h+h+hc[j])mod 8191;
...
if h>0 then h:=h-1 else h:=8191;end;45:hn:=hn-1{:930};
...
if hyphen_passed=0 then begin mem[s].hh.rh:=mem[7999996].hh.rh;
while mem[s].hh.rh>0 do s:=mem[s].hh.rh;if odd(hyf[j-1])then begin l:=j;
hyphen_passed:=j-1;mem[7999996].hh.rh:=0;end;end;
if hyphen_passed>0 then{914:}repeat r:=get_node(2);
mem[r].hh.rh:=mem[7999996].hh.rh;mem[r].hh.b0:=7;major_tail:=r;
r_count:=0;
...
if mem[7999996].hh.rh>0 then begin if minor_tail=0 then mem[r+1].hh.lh:=
mem[7999996].hh.rh else mem[minor_tail].hh.rh:=mem[7999996].hh.rh;
minor_tail:=mem[7999996].hh.rh;
...
if mem[7999996].hh.rh>0 then begin if minor_tail=0 then mem[r+1].hh.rh:=
mem[7999996].hh.rh else mem[minor_tail].hh.rh:=mem[7999996].hh.rh;
minor_tail:=mem[7999996].hh.rh;
while mem[minor_tail].hh.rh>0 do minor_tail:=mem[minor_tail].hh.rh;end;
until l>=j;while l>j do{917:}begin j:=reconstitute(j,hn,bchar,256)+1;
mem[major_tail].hh.rh:=mem[7999996].hh.rh;
while mem[major_tail].hh.rh>0 do begin major_tail:=mem[major_tail].hh.rh
...
mem[7999996].hh.rh:=0;until not odd(hyf[j-1]){:914};until j>hn;
...
if l=0 then begin if trie_op_ptr=trie_op_size then overflow(949,
trie_op_size);u:=trie_used[cur_lang];if u=255 then overflow(950,255);
...
{954:}if trie_max<h+256 then begin if trie_size<=h+256 then overflow(951
...
c:ASCII_code;
begin if trie_not_ready then begin if eqtb[603213].int<=0 then cur_lang
:=0 else if eqtb[603213].int>255 then cur_lang:=0 else cur_lang:=eqtb[
603213].int;scan_left_brace;{961:}k:=0;hyf[0]:=0;digit_sensed:=false;
while true do begin get_x_token;
case cur_cmd of 11,12:{962:}if digit_sensed or(cur_chr<48)or(cur_chr>57)
then begin if cur_chr=46 then cur_chr:=0 else begin cur_chr:=eqtb[
602139+cur_chr].hh.rh;
if cur_chr=0 then begin begin if interaction=3 then;print_nl(262);
print(957);end;begin help_ptr:=1;help_line[0]:=956;end;error;end;end;
if k<63 then begin k:=k+1;hc[k]:=cur_chr;hyf[k]:=0;digit_sensed:=false;
end;end else if k<63 then begin hyf[k]:=cur_chr-48;digit_sensed:=true;
end{:962};
...
overflow(951,trie_size);trie_ptr:=trie_ptr+1;trie_r[trie_ptr]:=p;
...
print(958);end;begin help_ptr:=1;help_line[0]:=956;end;error;end;
trie_o[q]:=v;end{:963};if cur_cmd=2 then goto 30;k:=0;hyf[0]:=0;
digit_sensed:=false;end;others:begin begin if interaction=3 then;
print_nl(262);print(955);end;print_esc(953);begin help_ptr:=1;
help_line[0]:=956;end;error;end end;end;30:{:961};
end else begin begin if interaction=3 then;print_nl(262);print(952);end;
print_esc(953);begin help_ptr:=1;help_line[0]:=954;end;error;
mem[7999988].hh.rh:=scan_toks(false,false);flush_list(def_ref);end;end;
...
{816:}mem[7999997].hh.rh:=mem[cur_list.head_field].hh.rh;
...
if(mem[eqtb[600789].hh.rh].hh.b1<>0)and(mem[eqtb[600789].hh.rh+3].int<>0
)then begin eqtb[600789].hh.rh:=finite_shrink(eqtb[600789].hh.rh);end;
if(mem[eqtb[600790].hh.rh].hh.b1<>0)and(mem[eqtb[600790].hh.rh+3].int<>0
)then begin eqtb[600790].hh.rh:=finite_shrink(eqtb[600790].hh.rh);end;
q:=eqtb[600789].hh.rh;r:=eqtb[600790].hh.rh;
...
{:834}{848:}if eqtb[601312].hh.rh=0 then if eqtb[603747].int=0 then
begin last_special_line:=0;second_width:=eqtb[603733].int;
second_indent:=0;
end else{849:}begin last_special_line:=abs(eqtb[603204].int);
if eqtb[603204].int<0 then begin first_width:=eqtb[603733].int-abs(eqtb[
603747].int);
if eqtb[603747].int>=0 then first_indent:=eqtb[603747].int else
first_indent:=0;second_width:=eqtb[603733].int;second_indent:=0;
end else begin first_width:=eqtb[603733].int;first_indent:=0;
second_width:=eqtb[603733].int-abs(eqtb[603747].int);
if eqtb[603747].int>=0 then second_indent:=eqtb[603747].int else
second_indent:=0;end;
end{:849}else begin last_special_line:=mem[eqtb[601312].hh.rh].hh.lh-1;
second_width:=mem[eqtb[601312].hh.rh+2*(last_special_line+1)].int;
second_indent:=mem[eqtb[601312].hh.rh+2*last_special_line+1].int;end;
if eqtb[603182].int=0 then easy_line:=last_special_line else easy_line:=
65535{:848};{863:}threshold:=eqtb[603163].int;
if threshold>=0 then begin{if eqtb[603195].int>0 then begin
begin_diagnostic;print_nl(933);end;}second_pass:=false;
final_pass:=false;end else begin threshold:=eqtb[603164].int;
second_pass:=true;final_pass:=(eqtb[603750].int<=0);
{if eqtb[603195].int>0 then begin_diagnostic;}end;
...
mem[q].hh.rh:=7999993;mem[q+1].hh.rh:=0;
mem[q+1].hh.lh:=cur_list.pg_field+1;mem[q+2].int:=0;
mem[7999993].hh.rh:=q;active_width[1]:=background[1];
active_width[2]:=background[2];active_width[3]:=background[3];
active_width[4]:=background[4];active_width[5]:=background[5];
active_width[6]:=background[6];passive:=0;printed_node:=7999997;
pass_number:=0;font_in_short_display:=0{:864};cur_p:=mem[7999997].hh.rh;
auto_breaking:=true;prev_p:=cur_p;
while(cur_p<>0)and(mem[7999993].hh.rh<>7999993)do{866:}begin if(cur_p>=
...
if eqtb[602139+c].hh.rh<>0 then if(eqtb[602139+c].hh.rh=c)or(eqtb[603201
...
if eqtb[602139+c].hh.rh=0 then goto 33;if hn=63 then goto 33;hb:=s;
hn:=hn+1;hu[hn]:=c;hc[hn]:=eqtb[602139+c].hh.rh;hyf_bchar:=256;
...
if eqtb[602139+c].hh.rh=0 then goto 33;if j=63 then goto 33;j:=j+1;
hu[j]:=c;hc[j]:=eqtb[602139+c].hh.rh;q:=mem[q].hh.rh;end;hb:=s;hn:=j;
...
if s=0 then try_break(eqtb[603167].int,1)else begin repeat{870:}if(s>=
...
others:confusion(937)end{:870};s:=mem[s].hh.rh;until s=0;
active_width[1]:=active_width[1]+disc_width;
try_break(eqtb[603166].int,1);
...
others:confusion(938)end{:871};r:=r-1;s:=mem[s].hh.rh;end;prev_p:=cur_p;
...
12:try_break(mem[cur_p+1].int,0);4,3,5:;others:confusion(936)end;
prev_p:=cur_p;cur_p:=mem[cur_p].hh.rh;35:end{:866};
if cur_p=0 then{873:}begin try_break(-10000,1);
if mem[7999993].hh.rh<>7999993 then begin{874:}r:=mem[7999993].hh.rh;
...
until r=7999993;best_line:=mem[best_bet+1].hh.lh{:874};
if eqtb[603182].int=0 then goto 30;{875:}begin r:=mem[7999993].hh.rh;
actual_looseness:=0;
repeat if mem[r].hh.b0<>2 then begin line_diff:=mem[r+1].hh.lh-best_line
;if((line_diff<actual_looseness)and(eqtb[603182].int<=line_diff))or((
line_diff>actual_looseness)and(eqtb[603182].int>=line_diff))then begin
...
r:=mem[r].hh.rh;until r=7999993;best_line:=mem[best_bet+1].hh.lh;
end{:875};
if(actual_looseness=eqtb[603182].int)or final_pass then goto 30;end;
end{:873};{865:}q:=mem[7999993].hh.rh;
while q<>7999993 do begin cur_p:=mem[q].hh.rh;
...
q:=cur_p;end{:865};
if not second_pass then begin{if eqtb[603195].int>0 then print_nl(934);}
threshold:=eqtb[603164].int;second_pass:=true;
final_pass:=(eqtb[603750].int<=0);
end else begin{if eqtb[603195].int>0 then print_nl(935);}
background[2]:=background[2]+eqtb[603750].int;final_pass:=true;end;end;
30:{if eqtb[603195].int>0 then begin end_diagnostic(true);
normalize_selector;end;}{:863};
{876:}post_line_break(final_widow_penalty){:876};
{865:}q:=mem[7999993].hh.rh;
while q<>7999993 do begin cur_p:=mem[q].hh.rh;
if mem[q].hh.b0=2 then free_node(q,7)else free_node(q,3);q:=cur_p;end;
q:=passive;while q<>0 do begin cur_p:=mem[q].hh.rh;free_node(q,2);
...
if eqtb[603213].int<=0 then cur_lang:=0 else if eqtb[603213].int>255
then cur_lang:=0 else cur_lang:=eqtb[603213].int;{935:}n:=0;p:=0;
while true do begin get_x_token;
...
end{:938}else begin if eqtb[602139+cur_chr].hh.rh=0 then begin begin if
interaction=3 then;print_nl(262);print(945);end;begin help_ptr:=2;
help_line[1]:=946;help_line[0]:=947;end;error;
end else if n<63 then begin n:=n+1;hc[n]:=eqtb[602139+cur_chr].hh.rh;
end;end{:937};16:begin scan_char_num;cur_chr:=cur_val;cur_cmd:=68;
goto 21;end;10,2:begin if n>1 then{939:}begin n:=n+1;hc[n]:=cur_lang;
begin if pool_ptr+n>pool_size then overflow(257,pool_size-init_pool_ptr)
;end;h:=0;for j:=1 to n do begin h:=(h+h+hc[j])mod 8191;
begin str_pool[pool_ptr]:=hc[j];pool_ptr:=pool_ptr+1;end;end;
s:=make_string;{940:}if hyph_count=8191 then overflow(948,8191);
...
if h>0 then h:=h-1 else h:=8191;end;hyph_word[h]:=s;
...
end;print_esc(941);print(942);begin help_ptr:=2;help_line[1]:=943;
help_line[0]:=944;end;error;end{:936}end;end{:935};10:end;
{:934}{968:}function prune_page_top(p:halfword):halfword;
var prev_p:halfword;q:halfword;begin prev_p:=7999997;
mem[7999997].hh.rh:=p;
...
end;others:confusion(959)end;prune_page_top:=mem[7999997].hh.rh;end;
...
then;print_nl(262);print(961);end;begin help_ptr:=4;help_line[3]:=962;
help_line[2]:=963;help_line[1]:=964;help_line[0]:=922;end;error;
...
print(338);end;print_esc(965);print(966);print_esc(967);
begin help_ptr:=2;help_line[1]:=968;help_line[0]:=969;end;error;
vsplit:=0;goto 10;end{:978};
q:=vert_break(mem[v+5].hh.rh,h,eqtb[603736].int);
{979:}p:=mem[v+5].hh.rh;
...
free_node(v,7);
if q=0 then eqtb[601578+n].hh.rh:=0 else eqtb[601578+n].hh.rh:=vpackage(
q,0,1,1073741823);vsplit:=vpackage(p,h,0,eqtb[603736].int);10:end;
...
print(978);end;if page_so_far[5]<>0 then begin print(312);
print_scaled(page_so_far[5]);print(979);end;
...
begin page_contents:=s;page_so_far[0]:=eqtb[603734].int;
page_max_depth:=eqtb[603735].int;page_so_far[7]:=0;page_so_far[1]:=0;
page_so_far[2]:=0;page_so_far[3]:=0;page_so_far[4]:=0;page_so_far[5]:=0;
page_so_far[6]:=0;least_page_cost:=1073741823;
{if eqtb[603196].int>0 then begin begin_diagnostic;print_nl(987);
print_scaled(page_so_far[0]);print(988);print_scaled(page_max_depth);
end_diagnostic(false);end;}end;
{:987}{992:}procedure box_error(n:eight_bits);begin error;
begin_diagnostic;print_nl(836);show_box(eqtb[601578+n].hh.rh);
end_diagnostic(true);flush_node_list(eqtb[601578+n].hh.rh);
eqtb[601578+n].hh.rh:=0;end;
{:992}{993:}procedure ensure_vbox(n:eight_bits);var p:halfword;
begin p:=eqtb[601578+n].hh.rh;
if p<>0 then if mem[p].hh.b0=0 then begin begin if interaction=3 then;
print_nl(262);print(989);end;begin help_ptr:=3;help_line[2]:=990;
help_line[1]:=991;help_line[0]:=992;end;box_error(n);end;end;
...
603202,mem[best_page_break+1].int);mem[best_page_break+1].int:=10000;
end else geq_word_define(603202,10000){:1013};
...
{1015:}if eqtb[601833].hh.rh<>0 then begin begin if interaction=3 then;
print_nl(262);print(338);end;print_esc(409);print(1003);
begin help_ptr:=2;help_line[1]:=1004;help_line[0]:=992;end;
box_error(255);end{:1015};insert_penalties:=0;
save_split_top_skip:=eqtb[600792].hh.rh;
if eqtb[603216].int<=0 then{1018:}begin r:=mem[8000000].hh.rh;
while r<>8000000 do begin if mem[r+2].hh.lh<>0 then begin n:=mem[r].hh.
b1-0;ensure_vbox(n);
if eqtb[601578+n].hh.rh=0 then eqtb[601578+n].hh.rh:=new_null_box;
p:=eqtb[601578+n].hh.rh+5;while mem[p].hh.rh<>0 do p:=mem[p].hh.rh;
mem[r+2].hh.rh:=p;end;r:=mem[r].hh.rh;end;end{:1018};q:=7999996;
mem[q].hh.rh:=0;prev_p:=7999998;p:=mem[prev_p].hh.rh;
while p<>best_page_break do begin if mem[p].hh.b0=3 then begin if eqtb[
603216].int<=0 then{1020:}begin r:=mem[8000000].hh.rh;
...
.rh do s:=mem[s].hh.rh;mem[s].hh.rh:=0;
eqtb[600792].hh.rh:=mem[p+4].hh.rh;
...
n:=mem[r].hh.b1-0;temp_ptr:=mem[eqtb[601578+n].hh.rh+5].hh.rh;
free_node(eqtb[601578+n].hh.rh,7);
eqtb[601578+n].hh.rh:=vpackage(temp_ptr,0,1,1073741823);
...
p:=mem[prev_p].hh.rh;end;eqtb[600792].hh.rh:=save_split_top_skip;
{1017:}if p<>0 then begin if mem[7999999].hh.rh=0 then if nest_ptr=0
then cur_list.tail_field:=page_tail else nest[0].tail_field:=page_tail;
mem[page_tail].hh.rh:=mem[7999999].hh.rh;mem[7999999].hh.rh:=p;
mem[prev_p].hh.rh:=0;end;save_vbadness:=eqtb[603190].int;
eqtb[603190].int:=10000;save_vfuzz:=eqtb[603739].int;
eqtb[603739].int:=1073741823;
eqtb[601833].hh.rh:=vpackage(mem[7999998].hh.rh,best_size,0,
page_max_depth);eqtb[603190].int:=save_vbadness;
eqtb[603739].int:=save_vfuzz;
if last_glue<>65535 then delete_glue_ref(last_glue);
{991:}page_contents:=0;page_tail:=7999998;mem[7999998].hh.rh:=0;
last_glue:=65535;last_penalty:=0;last_kern:=0;page_so_far[7]:=0;
page_max_depth:=0{:991};
if q<>7999996 then begin mem[7999998].hh.rh:=mem[7999996].hh.rh;
page_tail:=q;end{:1017};{1019:}r:=mem[8000000].hh.rh;
while r<>8000000 do begin q:=mem[r].hh.rh;free_node(r,4);r:=q;end;
mem[8000000].hh.rh:=8000000{:1019}{:1014};
if(cur_mark[0]<>0)and(cur_mark[1]=0)then begin cur_mark[1]:=cur_mark[0];
mem[cur_mark[0]].hh.lh:=mem[cur_mark[0]].hh.lh+1;end;
if eqtb[601313].hh.rh<>0 then if dead_cycles>=eqtb[603203].int then
{1024:}begin begin if interaction=3 then;print_nl(262);print(1005);end;
print_int(dead_cycles);print(1006);begin help_ptr:=3;help_line[2]:=1007;
help_line[1]:=1008;help_line[0]:=1009;end;error;
...
begin_token_list(eqtb[601313].hh.rh,6);new_save_level(8);
normal_paragraph;scan_left_brace;goto 10;end{:1025};
{1023:}begin if mem[7999998].hh.rh<>0 then begin if mem[7999999].hh.rh=0
then if nest_ptr=0 then cur_list.tail_field:=page_tail else nest[0].
tail_field:=page_tail else mem[page_tail].hh.rh:=mem[7999999].hh.rh;
mem[7999999].hh.rh:=mem[7999998].hh.rh;mem[7999998].hh.rh:=0;
page_tail:=7999998;end;ship_out(eqtb[601833].hh.rh);
eqtb[601833].hh.rh:=0;end{:1023};10:end;{:1012}procedure build_page;
label 10,30,31,22,80,90;var p:halfword;q,r:halfword;b,c:integer;
pi:integer;n:0..255;delta,h,w:scaled;
begin if(mem[7999999].hh.rh=0)or output_active then goto 10;
repeat 22:p:=mem[7999999].hh.rh;
...
mem[q].hh.rh:=p;mem[7999999].hh.rh:=q;goto 22;
...
if eqtb[601578+n].hh.rh=0 then mem[r+3].int:=0 else mem[r+3].int:=mem[
eqtb[601578+n].hh.rh+3].int+mem[eqtb[601578+n].hh.rh+2].int;
mem[r+2].hh.lh:=0;q:=eqtb[600800+n].hh.rh;
if eqtb[603218+n].int=1000 then h:=mem[r+3].int else h:=x_over_n(mem[r+3
].int,1000)*eqtb[603218+n].int;
...
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;print_nl(262);print(998);end;print_esc(395);print_int(n);
begin help_ptr:=3;help_line[2]:=999;help_line[1]:=1000;
help_line[0]:=922;end;error;end;end{:1009};
...
if eqtb[603218+n].int=1000 then h:=mem[p+3].int else h:=x_over_n(mem[p+3
].int,1000)*eqtb[603218+n].int;
if((h<=0)or(h<=delta))and(mem[p+3].int+mem[r+3].int<=eqtb[603751+n].int)
then begin page_so_far[0]:=page_so_far[0]-h;
mem[r+3].int:=mem[r+3].int+mem[p+3].int;
end else{1010:}begin if eqtb[603218+n].int<=0 then w:=1073741823 else
begin w:=page_so_far[0]-page_so_far[1]-page_so_far[7];
if eqtb[603218+n].int<>1000 then w:=x_over_n(w,eqtb[603218+n].int)*1000;
end;
if w>eqtb[603751+n].int-mem[r+3].int then w:=eqtb[603751+n].int-mem[r+3]
.int;q:=vert_break(mem[p+4].hh.lh,w,mem[p+2].int);
mem[r+3].int:=mem[r+3].int+best_height_plus_depth;
{if eqtb[603196].int>0 then[1011:]begin begin_diagnostic;print_nl(1001);
print_int(n);print(1002);print_scaled(w);print_char(44);
print_scaled(best_height_plus_depth);print(931);
...
if eqtb[603218+n].int<>1000 then best_height_plus_depth:=x_over_n(
best_height_plus_depth,1000)*eqtb[603218+n].int;
...
end;goto 80;end{:1008};others:confusion(993)end{:1000};
...
{if eqtb[603196].int>0 then[1006:]begin begin_diagnostic;print_nl(37);
print(927);print_totals;print(996);print_scaled(page_so_far[0]);
print(930);if b=1073741823 then print_char(42)else print_int(b);
print(931);print_int(pi);print(997);
...
best_size:=page_so_far[0];least_page_cost:=c;r:=mem[8000000].hh.rh;
while r<>8000000 do begin mem[r+2].hh.lh:=mem[r+2].hh.rh;
r:=mem[r].hh.rh;end;end;
if(c=1073741823)or(pi<=-10000)then begin fire_up(p);
...
page_so_far[6]:=page_so_far[6]+mem[q+3].int;
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;print_nl(262);print(994);end;begin help_ptr:=4;help_line[3]:=995;
help_line[2]:=963;help_line[1]:=964;help_line[0]:=922;end;error;
r:=new_spec(q);mem[r].hh.b1:=0;delete_glue_ref(q);mem[p+1].hh.lh:=r;
...
mem[7999999].hh.rh:=mem[p].hh.rh;mem[p].hh.rh:=0;goto 30{:998};
31:{999:}mem[7999999].hh.rh:=mem[p].hh.rh;mem[p].hh.rh:=0;
flush_node_list(p){:999};30:{:997};until mem[7999999].hh.rh=0;
{995:}if nest_ptr=0 then cur_list.tail_field:=7999999 else nest[0].
tail_field:=7999999{:995};10:end;
{:994}{1030:}{1043:}procedure app_space;var q:halfword;
begin if(cur_list.aux_field.hh.lh>=2000)and(eqtb[600795].hh.rh<>0)then q
:=new_param_glue(13)else begin if eqtb[600794].hh.rh<>0 then main_p:=
eqtb[600794].hh.rh else{1042:}begin main_p:=font_glue[eqtb[601834].hh.rh
];if main_p=0 then begin main_p:=new_spec(0);
main_k:=param_base[eqtb[601834].hh.rh]+2;
mem[main_p+1].int:=font_info[main_k].int;
mem[main_p+2].int:=font_info[main_k+1].int;
mem[main_p+3].int:=font_info[main_k+2].int;
font_glue[eqtb[601834].hh.rh]:=main_p;end;end{:1042};
main_p:=new_spec(main_p);
{1044:}if cur_list.aux_field.hh.lh>=2000 then mem[main_p+1].int:=mem[
main_p+1].int+font_info[7+param_base[eqtb[601834].hh.rh]].int;
...
cur_tok:=804;begin if interaction=3 then;print_nl(262);print(1017);end;
begin help_ptr:=2;help_line[1]:=1018;help_line[0]:=1019;end;ins_error;
end;{:1047}{1049:}procedure you_cant;begin begin if interaction=3 then;
print_nl(262);print(685);end;print_cmd_chr(cur_cmd,cur_chr);print(1020);
print_mode(cur_list.mode_field);end;
{:1049}{1050:}procedure report_illegal_case;begin you_cant;
begin help_ptr:=4;help_line[3]:=1021;help_line[2]:=1022;
help_line[1]:=1023;help_line[0]:=1024;end;error;end;
...
begin if privileged then begin if(7999998=page_tail)and(cur_list.
...
cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
mem[cur_list.tail_field+1].int:=eqtb[603733].int;
...
print_nl(262);print(777);end;print_cmd_chr(cur_cmd,cur_chr);
begin help_ptr:=1;help_line[0]:=1043;end;error;
end{:1066}else begin back_input;p:=get_avail;mem[7999997].hh.rh:=p;
begin if interaction=3 then;print_nl(262);print(625);end;
{1065:}case cur_group of 14:begin mem[p].hh.lh:=604611;print_esc(516);
end;15:begin mem[p].hh.lh:=804;print_char(36);end;
16:begin mem[p].hh.lh:=604612;mem[p].hh.rh:=get_avail;p:=mem[p].hh.rh;
mem[p].hh.lh:=3118;print_esc(1042);end;others:begin mem[p].hh.lh:=637;
print_char(125);end end{:1065};print(626);
begin_token_list(mem[7999997].hh.rh,4);begin help_ptr:=5;
help_line[4]:=1037;help_line[3]:=1038;help_line[2]:=1039;
help_line[1]:=1040;help_line[0]:=1041;end;error;end;end;
{:1064}{1069:}procedure extra_right_brace;
begin begin if interaction=3 then;print_nl(262);print(1048);end;
case cur_group of 14:print_esc(516);15:print_char(36);16:print_esc(877);
end;begin help_ptr:=5;help_line[4]:=1049;help_line[3]:=1050;
help_line[2]:=1051;help_line[1]:=1052;help_line[0]:=1053;end;error;
align_state:=align_state+1;end;{:1069}{1070:}procedure normal_paragraph;
begin if eqtb[603182].int<>0 then eq_word_define(603182,0);
if eqtb[603747].int<>0 then eq_word_define(603747,0);
if eqtb[603204].int<>1 then eq_word_define(603204,1);
if eqtb[601312].hh.rh<>0 then eq_define(601312,118,0);end;
...
if adjust_tail<>0 then begin if 7999995<>adjust_tail then begin mem[
cur_list.tail_field].hh.rh:=mem[7999995].hh.rh;
...
1073742080 then eq_define(-1073140246+box_context,119,cur_box)else
geq_define(-1073140502+box_context,119,cur_box){:1077}else if cur_box<>0
...
end else begin begin if interaction=3 then;print_nl(262);print(1066);
end;begin help_ptr:=3;help_line[2]:=1067;help_line[1]:=1068;
help_line[0]:=1069;end;back_error;flush_node_list(cur_box);end;
...
cur_box:=eqtb[601578+cur_val].hh.rh;eqtb[601578+cur_val].hh.rh:=0;end;
1:begin scan_eight_bit_int;
cur_box:=copy_node_list(eqtb[601578+cur_val].hh.rh);end;
2:{1080:}begin cur_box:=0;
if abs(cur_list.mode_field)=203 then begin you_cant;begin help_ptr:=1;
help_line[0]:=1070;end;error;
end else if(cur_list.mode_field=1)and(cur_list.head_field=cur_list.
tail_field)then begin you_cant;begin help_ptr:=2;help_line[1]:=1071;
help_line[0]:=1072;end;error;
...
if not scan_keyword(842)then begin begin if interaction=3 then;
print_nl(262);print(1073);end;begin help_ptr:=2;help_line[1]:=1074;
help_line[0]:=1075;end;error;end;scan_dimen(false,false,false);
...
if eqtb[601318].hh.rh<>0 then begin_token_list(eqtb[601318].hh.rh,11);
end else begin cur_list.aux_field.hh.lh:=1000;
if eqtb[601317].hh.rh<>0 then begin_token_list(eqtb[601317].hh.rh,10);
end;goto 10;end{:1083}end;box_end(box_context);10:end;
...
print_nl(262);print(1076);end;begin help_ptr:=3;help_line[2]:=1077;
help_line[1]:=1078;help_line[0]:=1079;end;back_error;end;end;
{:1084}{1086:}procedure package(c:small_number);var h:scaled;p:halfword;
d:scaled;begin d:=eqtb[603737].int;unsave;save_ptr:=save_ptr-3;
...
if eqtb[603213].int<=0 then cur_lang:=0 else if eqtb[603213].int>255
then cur_lang:=0 else cur_lang:=eqtb[603213].int;
cur_list.aux_field.hh.rh:=cur_lang;
cur_list.pg_field:=(norm_min(eqtb[603214].int)*64+norm_min(eqtb[603215].
int))*65536+cur_lang;
if indented then begin cur_list.tail_field:=new_null_box;
mem[cur_list.head_field].hh.rh:=cur_list.tail_field;
mem[cur_list.tail_field+1].int:=eqtb[603730].int;end;
if eqtb[601314].hh.rh<>0 then begin_token_list(eqtb[601314].hh.rh,7);
...
print_esc(521);print(1082);begin help_ptr:=2;help_line[1]:=1083;
help_line[0]:=1084;end;error;end else begin back_input;
...
cur_list.tail_field then pop_nest else line_break(eqtb[603169].int);
...
print(1085);end;print_esc(330);print_int(255);begin help_ptr:=1;
help_line[0]:=1086;end;error;cur_val:=0;end;end;
...
begin you_cant;begin help_ptr:=2;help_line[1]:=1071;help_line[0]:=1087;
end;if cur_chr=11 then help_line[0]:=(1088)else if cur_chr<>10 then
help_line[0]:=(1089);error;end;
...
begin c:=cur_chr;scan_eight_bit_int;p:=eqtb[601578+cur_val].hh.rh;
if p=0 then goto 10;
...
begin begin if interaction=3 then;print_nl(262);print(1097);end;
begin help_ptr:=3;help_line[2]:=1098;help_line[1]:=1099;
help_line[0]:=1100;end;error;goto 10;end;
...
eqtb[601578+cur_val].hh.rh:=0;free_node(p,7);end;
...
cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
if cur_chr=1 then begin c:=hyphen_char[eqtb[601834].hh.rh];
if c>=0 then if c<256 then mem[cur_list.tail_field+1].hh.lh:=
new_character(eqtb[601834].hh.rh,c);end else begin save_ptr:=save_ptr+1;
...
=3 then;print_nl(262);print(1107);end;begin help_ptr:=1;
help_line[0]:=1108;end;error;begin_diagnostic;print_nl(1109);
...
if interaction=3 then;print_nl(262);print(1101);end;print_esc(349);
begin help_ptr:=2;help_line[1]:=1102;help_line[0]:=1103;end;
...
interaction=3 then;print_nl(262);print(1104);end;begin help_ptr:=2;
help_line[1]:=1105;help_line[0]:=1106;end;error;end;
...
begin scan_char_num;f:=eqtb[601834].hh.rh;p:=new_character(f,cur_val);
...
.int;do_assignments;{1124:}q:=0;f:=eqtb[601834].hh.rh;
...
;print_nl(262);print(1114);end;print_cmd_chr(cur_cmd,cur_chr);
if cur_tok=1062 then begin begin help_ptr:=6;help_line[5]:=1115;
help_line[4]:=1116;help_line[3]:=1117;help_line[2]:=1118;
help_line[1]:=1119;help_line[0]:=1120;end;
end else begin begin help_ptr:=5;help_line[4]:=1115;help_line[3]:=1121;
help_line[2]:=1118;help_line[1]:=1119;help_line[0]:=1120;end;end;error;
...
end else begin begin if interaction=3 then;print_nl(262);print(1110);
end;align_state:=align_state-1;cur_tok:=637;end;begin help_ptr:=3;
help_line[2]:=1111;help_line[1]:=1112;help_line[0]:=1113;end;ins_error;
end;end;{:1127}{1129:}procedure no_align_error;
begin begin if interaction=3 then;print_nl(262);print(1114);end;
print_esc(527);begin help_ptr:=2;help_line[1]:=1122;help_line[0]:=1123;
end;error;end;procedure omit_error;begin begin if interaction=3 then;
print_nl(262);print(1114);end;print_esc(530);begin help_ptr:=2;
help_line[1]:=1124;help_line[0]:=1123;end;error;end;
...
begin begin if interaction=3 then;print_nl(262);print(777);end;
print_esc(505);begin help_ptr:=1;help_line[0]:=1126;end;error;end;
...
end else begin line_break(eqtb[603170].int);
{1146:}v:=mem[just_box+4].int+2*font_info[6+param_base[eqtb[601834].hh.
rh]].int;w:=-1073741823;p:=mem[just_box+5].hh.rh;
...
goto 40;end;6:{652:}begin mem[7999988]:=mem[p+1];
mem[7999988].hh.rh:=mem[p].hh.rh;p:=7999988;goto 21;end{:652};
...
{1149:}if eqtb[601312].hh.rh=0 then if(eqtb[603747].int<>0)and(((eqtb[
603204].int>=0)and(cur_list.pg_field+2>eqtb[603204].int))or(cur_list.
pg_field+1<-eqtb[603204].int))then begin l:=eqtb[603733].int-abs(eqtb[
603747].int);if eqtb[603747].int>0 then s:=eqtb[603747].int else s:=0;
end else begin l:=eqtb[603733].int;s:=0;
end else begin n:=mem[eqtb[601312].hh.rh].hh.lh;
if cur_list.pg_field+2>=n then p:=eqtb[601312].hh.rh+2*n else p:=eqtb[
601312].hh.rh+2*(cur_list.pg_field+2);s:=mem[p-1].int;l:=mem[p].int;
end{:1149};push_math(15);cur_list.mode_field:=203;
eq_word_define(603207,-1);eq_word_define(603743,w);
eq_word_define(603744,l);eq_word_define(603745,s);
if eqtb[601316].hh.rh<>0 then begin_token_list(eqtb[601316].hh.rh,9);
if nest_ptr=1 then build_page;end{:1145}else begin back_input;
{1139:}begin push_math(15);eq_word_define(603207,-1);
if eqtb[601315].hh.rh<>0 then begin_token_list(eqtb[601315].hh.rh,8);
...
until(cur_cmd<>10)and(cur_cmd<>0){:404};
21:case cur_cmd of 11,12,68:begin c:=eqtb[602907+cur_chr].hh.rh-0;
...
if(c>=28672)and((eqtb[603207].int>=0)and(eqtb[603207].int<16))then mem[p
].hh.b0:=eqtb[603207].int else mem[p].hh.b0:=(c div 256)mod 16;10:end;
...
if c>=28672 then begin if((eqtb[603207].int>=0)and(eqtb[603207].int<16))
then mem[p+1].hh.b0:=eqtb[603207].int;mem[p].hh.b0:=16;
...
goto 10;end;begin if interaction=3 then;print_nl(262);print(1130);end;
begin help_ptr:=1;help_line[0]:=1131;end;error;10:end;
...
case cur_cmd of 11,12:cur_val:=eqtb[603474+cur_chr].int;
...
print(1132);end;begin help_ptr:=6;help_line[5]:=1133;help_line[4]:=1134;
help_line[3]:=1135;help_line[2]:=1136;help_line[1]:=1137;
help_line[0]:=1138;end;back_error;cur_val:=0;end{:1161};
...
print_nl(262);print(1139);end;print_esc(523);print(1140);
begin help_ptr:=2;help_line[1]:=1141;help_line[0]:=1142;end;error;
...
if(cur_val>=28672)and((eqtb[603207].int>=0)and(eqtb[603207].int<16))then
mem[cur_list.tail_field+4].hh.b0:=eqtb[603207].int else mem[cur_list.
...
aux_field.int+2].hh.lh;if mem[q].hh.b0<>30 then confusion(877);
...
print_nl(262);print(1143);end;begin help_ptr:=1;help_line[0]:=1144;end;
end else begin begin if interaction=3 then;print_nl(262);print(1145);
end;begin help_ptr:=1;help_line[0]:=1146;end;end;error;end;end{:1177};
...
scan_delimiter(7999988,false);scan_delimiter(7999988,false);end;
if c mod 3=0 then scan_dimen(false,false,false);
begin if interaction=3 then;print_nl(262);print(1153);end;
begin help_ptr:=3;help_line[2]:=1154;help_line[1]:=1155;
help_line[0]:=1156;end;error;
...
scan_delimiter(7999988,false);begin if interaction=3 then;print_nl(262);
print(777);end;print_esc(877);begin help_ptr:=1;help_line[0]:=1157;end;
...
{1195:}if(font_params[eqtb[601837].hh.rh]<22)or(font_params[eqtb[601853]
.hh.rh]<22)or(font_params[eqtb[601869].hh.rh]<22)then begin begin if
interaction=3 then;print_nl(262);print(1158);end;begin help_ptr:=3;
help_line[2]:=1159;help_line[1]:=1160;help_line[0]:=1161;end;error;
flush_math;danger:=true;
end else if(font_params[eqtb[601838].hh.rh]<13)or(font_params[eqtb[
601854].hh.rh]<13)or(font_params[eqtb[601870].hh.rh]<13)then begin begin
if interaction=3 then;print_nl(262);print(1162);end;begin help_ptr:=3;
help_line[2]:=1163;help_line[1]:=1164;help_line[0]:=1165;end;error;
...
mlist_penalties:=false;mlist_to_hlist;a:=hpack(mem[7999997].hh.rh,0,1);
...
eqtb[603731].int,0);cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;
end;cur_mlist:=p;cur_style:=2;mlist_penalties:=(cur_list.mode_field>0);
mlist_to_hlist;mem[cur_list.tail_field].hh.rh:=mem[7999997].hh.rh;
while mem[cur_list.tail_field].hh.rh<>0 do cur_list.tail_field:=mem[
cur_list.tail_field].hh.rh;
begin mem[cur_list.tail_field].hh.rh:=new_math(eqtb[603731].int,1);
cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
...
mlist_penalties:=false;mlist_to_hlist;p:=mem[7999997].hh.rh;
adjust_tail:=7999995;b:=hpack(p,0,1);p:=mem[b+5].hh.rh;t:=adjust_tail;
adjust_tail:=0;w:=mem[b+1].int;z:=eqtb[603744].int;s:=eqtb[603745].int;
if(a=0)or danger then begin e:=0;q:=0;end else begin e:=mem[a+1].int;
q:=e+font_info[6+param_base[eqtb[601837].hh.rh]].int;end;
...
{1203:}begin mem[cur_list.tail_field].hh.rh:=new_penalty(eqtb[603174].
int);cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
if(d+s<=eqtb[603743].int)or l then begin g1:=3;g2:=4;
...
if t<>7999995 then begin mem[cur_list.tail_field].hh.rh:=mem[7999995].hh
.rh;cur_list.tail_field:=t;end;
begin mem[cur_list.tail_field].hh.rh:=new_penalty(eqtb[603175].int);
cur_list.tail_field:=mem[cur_list.tail_field].hh.rh;end;
...
begin if cur_group<>15 then confusion(1169);unsave;
...
if(cur_cs=0)or(cur_cs>600514)then begin begin if interaction=3 then;
print_nl(262);print(1184);end;begin help_ptr:=5;help_line[4]:=1185;
help_line[3]:=1186;help_line[2]:=1187;help_line[1]:=1188;
help_line[0]:=1189;end;if cur_cs=0 then back_input;cur_tok:=604609;
...
print_cmd_chr(q,0);begin help_ptr:=1;help_line[0]:=1210;end;error;
goto 10;end;end;p:=cur_chr;scan_eight_bit_int;
case p of 0:l:=cur_val+603218;1:l:=cur_val+603751;2:l:=cur_val+600800;
3:l:=cur_val+601056;end;end;40:{:1237};
if q=89 then scan_optional_equals else if scan_keyword(1206)then;
arith_error:=false;
...
print_nl(262);print(1207);end;begin help_ptr:=2;help_line[1]:=1208;
help_line[0]:=1209;end;if p>=2 then delete_glue_ref(cur_val);error;
goto 10;end;
...
if(cur_val<=0)or(cur_val>32767)then begin begin if interaction=3 then;
print_nl(262);print(1213);end;begin help_ptr:=1;help_line[0]:=1214;end;
...
print_nl(262);print(955);end;print_esc(532);begin help_ptr:=1;
help_line[0]:=1215;end;int_error(cur_val);
...
scan_dimen(false,false,false);
if eqtb[601578+b].hh.rh<>0 then mem[eqtb[601578+b].hh.rh+c].int:=cur_val
...
else t:=u-257 else begin old_setting:=selector;selector:=21;print(1219);
...
if scan_keyword(1220)then{1259:}begin scan_dimen(false,false,false);
s:=cur_val;
if(s<=0)or(s>=134217728)then begin begin if interaction=3 then;
print_nl(262);print(1222);end;print_scaled(s);print(1223);
begin help_ptr:=2;help_line[1]:=1224;help_line[0]:=1225;end;error;
s:=10*65536;end;end{:1259}else if scan_keyword(1221)then begin scan_int;
s:=-cur_val;
...
eqtb[600524+f]:=eqtb[u];hash[600524+f].rh:=t;end;
...
print_nl(262);print(1179);end;print_cmd_chr(cur_cmd,cur_chr);
print_char(39);begin help_ptr:=1;help_line[0]:=1180;end;back_error;
goto 10;end{:1212};end;
{1213:}if(cur_cmd<>97)and(a mod 4<>0)then begin begin if interaction=3
then;print_nl(262);print(685);end;print_esc(1171);print(1181);
print_esc(1172);print(1182);print_cmd_chr(cur_cmd,cur_chr);
print_char(39);begin help_ptr:=1;help_line[0]:=1183;end;error;
end{:1213};
{1214:}if eqtb[603206].int<>0 then if eqtb[603206].int<0 then begin if(a
>=4)then a:=a-4;end else begin if not(a>=4)then a:=a+4;end{:1214};
case cur_cmd of{1217:}87:if(a>=4)then geq_define(601834,120,cur_chr)else
eq_define(601834,120,cur_chr);
{:1217}{1218:}97:begin if odd(cur_chr)and not(a>=4)and(eqtb[603206].int
...
case n of 2:if(a>=4)then geq_define(p,73,603218+cur_val)else eq_define(p
,73,603218+cur_val);
3:if(a>=4)then geq_define(p,74,603751+cur_val)else eq_define(p,74,
603751+cur_val);
4:if(a>=4)then geq_define(p,75,600800+cur_val)else eq_define(p,75,
600800+cur_val);
5:if(a>=4)then geq_define(p,76,601056+cur_val)else eq_define(p,76,
601056+cur_val);
6:if(a>=4)then geq_define(p,72,601322+cur_val)else eq_define(p,72,
601322+cur_val);end;end end;end;{:1224}{1225:}96:begin scan_int;
n:=cur_val;
if not scan_keyword(842)then begin begin if interaction=3 then;
print_nl(262);print(1073);end;begin help_ptr:=2;help_line[1]:=1200;
help_line[0]:=1201;end;error;end;get_r_token;p:=cur_cs;read_toks(n,p);
if(a>=4)then geq_define(p,111,cur_val)else eq_define(p,111,cur_val);end;
{:1225}{1226:}71,72:begin q:=cur_cs;
if cur_cmd=71 then begin scan_eight_bit_int;p:=601322+cur_val;
end else p:=cur_chr;scan_optional_equals;{404:}repeat get_x_token;
until(cur_cmd<>10)and(cur_cmd<>0){:404};
if cur_cmd<>1 then{1227:}begin if cur_cmd=71 then begin
scan_eight_bit_int;cur_cmd:=72;cur_chr:=601322+cur_val;end;
...
end else begin if p=601313 then begin mem[q].hh.rh:=get_avail;
...
{:1228}{1232:}85:begin{1233:}if cur_chr=601883 then n:=15 else if
cur_chr=602907 then n:=32768 else if cur_chr=602651 then n:=32767 else
if cur_chr=603474 then n:=16777215 else n:=255{:1233};p:=cur_chr;
scan_char_num;p:=p+cur_val;scan_optional_equals;scan_int;
if((cur_val<0)and(p<603474))or(cur_val>n)then begin begin if interaction
=3 then;print_nl(262);print(1202);end;print_int(cur_val);
if p<603474 then print(1203)else print(1204);print_int(n);
begin help_ptr:=1;help_line[0]:=1205;end;error;cur_val:=0;end;
if p<602907 then if(a>=4)then geq_define(p,120,cur_val)else eq_define(p,
120,cur_val)else if p<603474 then if(a>=4)then geq_define(p,120,cur_val
+0)else eq_define(p,120,cur_val+0)else if(a>=4)then geq_word_define(p,
...
begin help_ptr:=2;help_line[1]:=1211;help_line[0]:=1212;end;error;end;
...
if(a>=4)then geq_define(601312,118,p)else eq_define(601312,118,p);end;
{:1248}{1252:}99:if cur_chr=1 then begin new_patterns;goto 30;
begin if interaction=3 then;print_nl(262);print(1216);end;help_ptr:=0;
...
{:1264}others:confusion(1178)end;
...
s:str_number;begin c:=cur_chr;mem[7999988].hh.rh:=scan_toks(false,true);
...
if eqtb[601321].hh.rh<>0 then use_err_help:=true else if long_help_seen
then begin help_ptr:=1;help_line[0]:=1232;
end else begin if interaction<3 then long_help_seen:=true;
begin help_ptr:=4;help_line[3]:=1233;help_line[2]:=1234;
help_line[1]:=1235;help_line[0]:=1236;end;end;error;use_err_help:=false;
...
1:{1296:}begin scan_eight_bit_int;begin_diagnostic;print_nl(1254);
print_int(cur_val);print_char(61);
if eqtb[601578+cur_val].hh.rh=0 then print(410)else show_box(eqtb[
601578+cur_val].hh.rh);end{:1296};0:{1294:}begin get_token;
if interaction=3 then;print_nl(1248);
if cur_cs<>0 then begin sprint_cs(cur_cs);print_char(61);end;
print_meaning;goto 50;end{:1294};others:{1297:}begin p:=the_toks;
if interaction=3 then;print_nl(1248);token_show(7999997);
flush_list(mem[7999997].hh.rh);goto 50;end{:1297}end;
{1298:}end_diagnostic(true);begin if interaction=3 then;print_nl(262);
print(1255);end;
if selector=19 then if eqtb[603192].int<=0 then begin selector:=17;
print(1256);selector:=19;end{:1298};
50:if interaction<3 then begin help_ptr:=0;error_count:=error_count-1;
end else if eqtb[603192].int>0 then begin begin help_ptr:=3;
help_line[2]:=1243;help_line[1]:=1244;help_line[0]:=1245;end;
end else begin begin help_ptr:=5;help_line[4]:=1243;help_line[3]:=1244;
help_line[2]:=1245;help_line[1]:=1246;help_line[0]:=1247;end;end;error;
...
print_nl(262);print(1258);end;begin help_ptr:=1;help_line[0]:=1259;end;
begin if interaction=3 then interaction:=2;if log_opened then error;
{if interaction>0 then debug_help;}history:=3;jump_out;end;end{:1304};
{1328:}selector:=21;print(1272);print(job_name);print_char(32);
print_int(eqtb[603186].int);print_char(46);print_int(eqtb[603185].int);
print_char(46);print_int(eqtb[603184].int);print_char(41);
if interaction=0 then selector:=18 else selector:=19;
begin if pool_ptr+1>pool_size then overflow(257,pool_size-init_pool_ptr)
;end;format_ident:=make_string;pack_job_name(786);
while not w_open_out(fmt_file)do prompt_file_name(1273,786);
print_nl(1274);slow_print(w_make_name_string(fmt_file));
begin str_ptr:=str_ptr-1;pool_ptr:=str_start[str_ptr];end;print_nl(338);
slow_print(format_ident){:1328};{1307:}begin fmt_file^.int:=504454778;
put(fmt_file);end;begin fmt_file^.int:=0;put(fmt_file);end;
begin fmt_file^.int:=8000000;put(fmt_file);end;
begin fmt_file^.int:=604006;put(fmt_file);end;begin fmt_file^.int:=1777;
put(fmt_file);end;begin fmt_file^.int:=8191;put(fmt_file);end{:1307};
...
print_ln;print_int(str_ptr);print(1260);print_int(pool_ptr){:1309};
...
print(1261);print_int(var_used);print_char(38);
print_int(dyn_used){:1311};{1313:}{1315:}k:=1;repeat j:=k;
while j<603162 do begin if(eqtb[j].hh.rh=eqtb[j+1].hh.rh)and(eqtb[j].hh.
b0=eqtb[j+1].hh.b0)and(eqtb[j].hh.b1=eqtb[j+1].hh.b1)then goto 41;
j:=j+1;end;l:=603163;goto 31;41:j:=j+1;l:=j;
while j<603162 do begin if(eqtb[j].hh.rh<>eqtb[j+1].hh.rh)or(eqtb[j].hh.
...
until k=603163{:1315};{1316:}repeat j:=k;
while j<604006 do begin if eqtb[j].int=eqtb[j+1].int then goto 42;
j:=j+1;end;l:=604007;goto 32;42:j:=j+1;l:=j;
while j<604006 do begin if eqtb[j].int<>eqtb[j+1].int then goto 32;
j:=j+1;end;32:begin fmt_file^.int:=l-k;put(fmt_file);end;
while k<l do begin begin fmt_file^:=eqtb[k];put(fmt_file);end;k:=k+1;
end;k:=j+1;begin fmt_file^.int:=k-l;put(fmt_file);end;
until k>604006{:1316};begin fmt_file^.int:=par_loc;put(fmt_file);end;
begin fmt_file^.int:=write_loc;put(fmt_file);end;
{1318:}begin fmt_file^.int:=hash_used;put(fmt_file);end;
cs_count:=600513-hash_used;
...
for p:=hash_used+1 to 600780 do begin fmt_file^.hh:=hash[p];
put(fmt_file);end;begin fmt_file^.int:=cs_count;put(fmt_file);end;
print_ln;print_int(cs_count);print(1262){:1318}{:1313};
...
print_nl(1265);print_esc(hash[600524+k].rh);print_char(61);
...
print_int(fmem_ptr-7);print(1263);print_int(font_ptr-0);print(1264);
if font_ptr<>1 then print_char(115){:1320};
{1324:}begin fmt_file^.int:=hyph_count;put(fmt_file);end;
for k:=0 to 8191 do if hyph_word[k]<>0 then begin begin fmt_file^.int:=k
...
print_int(hyph_count);print(1266);if hyph_count<>1 then print_char(115);
...
begin fmt_file^.int:=hyf_next[k];put(fmt_file);end;end;print_nl(1267);
print_int(trie_max);print(1268);print_int(trie_op_ptr);print(1269);
if trie_op_ptr<>1 then print_char(115);print(1270);
print_int(trie_op_size);
for k:=255 downto 0 do if trie_used[k]>0 then begin print_nl(800);
print_int(trie_used[k]-0);print(1271);print_int(k);
...
begin fmt_file^.int:=69069;put(fmt_file);end;eqtb[603194].int:=0{:1326};
...
mem[cur_list.tail_field+1].hh.b0:=norm_min(eqtb[603214].int);
mem[cur_list.tail_field+1].hh.b1:=norm_min(eqtb[603215].int);end{:1377};
others:confusion(1291)end;end;{:1348}{1376:}procedure fix_language;
var l:ASCII_code;
begin if eqtb[603213].int<=0 then l:=0 else if eqtb[603213].int>255 then
l:=0 else l:=eqtb[603213].int;
if l<>cur_list.aux_field.hh.rh then begin new_whatsit(4,2);
mem[cur_list.tail_field+1].hh.rh:=l;cur_list.aux_field.hh.rh:=l;
mem[cur_list.tail_field+1].hh.b0:=norm_min(eqtb[603214].int);
mem[cur_list.tail_field+1].hh.b1:=norm_min(eqtb[603215].int);end;end;
{:1376}{1068:}procedure handle_right_brace;var p,q:halfword;d:scaled;
f:integer;begin case cur_group of 1:unsave;
0:begin begin if interaction=3 then;print_nl(262);print(1044);end;
begin help_ptr:=2;help_line[1]:=1045;help_line[0]:=1046;end;error;end;
14,15,16:extra_right_brace;{1085:}2:package(0);
3:begin adjust_tail:=7999995;package(0);end;4:begin end_graf;package(0);
end;5:begin end_graf;package(4);end;{:1085}{1100:}11:begin end_graf;
q:=eqtb[600792].hh.rh;mem[q].hh.rh:=mem[q].hh.rh+1;d:=eqtb[603736].int;
f:=eqtb[603205].int;unsave;save_ptr:=save_ptr-1;
...
then;print_nl(262);print(1010);end;begin help_ptr:=2;help_line[1]:=1011;
help_line[0]:=1012;end;error;repeat get_token;
until cur_input.loc_field=0;end{:1027};end_token_list;end_graf;unsave;
output_active:=false;insert_penalties:=0;
{1028:}if eqtb[601833].hh.rh<>0 then begin begin if interaction=3 then;
print_nl(262);print(1013);end;print_esc(409);print_int(255);
begin help_ptr:=3;help_line[2]:=1014;help_line[1]:=1015;
help_line[0]:=1016;end;box_error(255);end{:1028};
...
if mem[7999998].hh.rh<>0 then begin if mem[7999999].hh.rh=0 then nest[0]
.tail_field:=page_tail;mem[page_tail].hh.rh:=mem[7999999].hh.rh;
mem[7999999].hh.rh:=mem[7999998].hh.rh;mem[7999998].hh.rh:=0;
page_tail:=7999998;end;pop_nest;build_page;end{:1026};
{:1100}{1118:}10:build_discretionary;{:1118}{1132:}6:begin back_input;
cur_tok:=604610;begin if interaction=3 then;print_nl(262);print(625);
end;print_esc(899);print(626);begin help_ptr:=1;help_line[0]:=1125;end;
...
end{:1187};end;{:1186}others:confusion(1047)end;end;
{:1068}procedure main_control;
label 60,21,70,80,90,91,92,95,100,101,110,111,112,120,10;var t:integer;
begin if eqtb[601319].hh.rh<>0 then begin_token_list(eqtb[601319].hh.rh,
12);60:get_x_token;
...
if eqtb[603199].int>0 then show_cur_cmd_chr{:1031};
...
scan_math(cur_list.tail_field+1);end;
{:1150}{1154:}214,215,271:set_math_char(eqtb[602907+cur_chr].hh.rh-0);
219:begin scan_char_num;cur_chr:=cur_val;
set_math_char(eqtb[602907+cur_chr].hh.rh-0);end;
...
if eqtb[601318].hh.rh<>0 then begin_token_list(eqtb[601318].hh.rh,11);
end;{:1167}{1171:}256:begin mem[cur_list.tail_field].hh.rh:=new_style(
...
70:{1034:}main_s:=eqtb[602651+cur_chr].hh.rh;
...
:=1000 else cur_list.aux_field.hh.lh:=main_s;main_f:=eqtb[601834].hh.rh;
bchar:=font_bchar[main_f];false_bchar:=font_false_bchar[main_f];
if cur_list.mode_field>0 then if eqtb[603213].int<>cur_list.aux_field.hh
...
101:main_s:=eqtb[602651+cur_chr].hh.rh;
if main_s=1000 then cur_list.aux_field.hh.lh:=1000 else if main_s<1000
then begin if main_s>0 then cur_list.aux_field.hh.lh:=main_s;
end else if cur_list.aux_field.hh.lh<1000 then cur_list.aux_field.hh.lh
...
120:{1041:}if eqtb[600794].hh.rh=0 then begin{1042:}begin main_p:=
font_glue[eqtb[601834].hh.rh];
if main_p=0 then begin main_p:=new_spec(0);
main_k:=param_base[eqtb[601834].hh.rh]+2;
mem[main_p+1].int:=font_info[main_k].int;
mem[main_p+2].int:=font_info[main_k+1].int;
...
begin token_show(eqtb[601321].hh.rh);end;
...
begin{1308:}x:=fmt_file^.int;if x<>504454778 then goto 6666;
...
begin get(fmt_file);x:=fmt_file^.int;end;if x<>604006 then goto 6666;
begin get(fmt_file);x:=fmt_file^.int;end;if x<>1777 then goto 6666;
begin get(fmt_file);x:=fmt_file^.int;end;
if x<>8191 then goto 6666{:1308};{1310:}begin begin get(fmt_file);
...
x:=fmt_file^.int;end;
if(x<1019)or(x>7999986)then goto 6666 else lo_mem_max:=x;end;
...
x:=fmt_file^.int;end;
if(x<lo_mem_max+1)or(x>7999987)then goto 6666 else hi_mem_min:=x;end;
begin begin get(fmt_file);x:=fmt_file^.int;end;
if(x<0)or(x>8000000)then goto 6666 else avail:=x;end;mem_end:=8000000;
...
if(x<1)or(k+x>604007)then goto 6666;
for j:=k to k+x-1 do begin get(fmt_file);eqtb[j]:=fmt_file^;end;k:=k+x;
begin get(fmt_file);x:=fmt_file^.int;end;
if(x<0)or(k+x>604007)then goto 6666;
for j:=k to k+x-1 do eqtb[j]:=eqtb[k-1];k:=k+x;until k>604006{:1317};
begin begin get(fmt_file);x:=fmt_file^.int;end;
if(x<514)or(x>600514)then goto 6666 else par_loc:=x;end;
par_token:=4095+par_loc;begin begin get(fmt_file);x:=fmt_file^.int;end;
if(x<514)or(x>600514)then goto 6666 else write_loc:=x;end;
{1319:}begin begin get(fmt_file);x:=fmt_file^.int;end;
if(x<514)or(x>600514)then goto 6666 else hash_used:=x;end;p:=513;
...
for p:=hash_used+1 to 600780 do begin get(fmt_file);
hash[p]:=fmt_file^.hh;end;begin get(fmt_file);cs_count:=fmt_file^.int;
end{:1319}{:1314};{1321:}begin begin get(fmt_file);x:=fmt_file^.int;end;
...
if(x<0)or(x>8191)then goto 6666 else hyph_count:=x;end;
for k:=1 to hyph_count do begin begin begin get(fmt_file);
x:=fmt_file^.int;end;if(x<0)or(x>8191)then goto 6666 else j:=x;end;
begin begin get(fmt_file);x:=fmt_file^.int;end;
...
){:1378};eqtb[603212].int:=-1;
{if eqtb[603194].int>0 then[1334:]if log_opened then begin write_ln(
log_file,' ');
...
' multiletter control sequences out of ',600000:1);
...
write_ln(log_file,' out of ',8191:1);
...
cur_s:=cur_s-1;end;
if total_pages=0 then print_nl(837)else begin begin dvi_buf[dvi_ptr]:=
...
if dvi_ptr>0 then write_dvi(0,dvi_ptr-1){:599};print_nl(838);
slow_print(output_file_name);print(286);print_int(total_pages);
print(839);if total_pages<>1 then print_char(115);print(840);
print_int(dvi_offset+dvi_ptr);print(841);b_close(dvi_file);end{:642};
if log_opened then begin write_ln(log_file);a_close(log_file);
selector:=selector-2;if selector=17 then begin print_nl(1275);
slow_print(log_name);print_char(46);end;end;end;
{:1333}{1335:}procedure final_cleanup;label 10;var c:small_number;
begin c:=cur_chr;if c<>1 then eqtb[603212].int:=-1;
if job_name=0 then open_log_file;
while input_ptr>0 do if cur_input.state_field=0 then end_token_list else
end_file_reading;while open_parens>0 do begin print(1276);
open_parens:=open_parens-1;end;if cur_level>1 then begin print_nl(40);
print_esc(1277);print(1278);print_int(cur_level-1);print_char(41);end;
while cond_ptr<>0 do begin print_nl(40);print_esc(1277);print(1279);
print_cmd_chr(105,cur_if);if if_line<>0 then begin print(1280);
print_int(if_line);end;print(1281);if_line:=mem[cond_ptr+1].int;
...
then begin selector:=17;print_nl(1282);selector:=19;end;
...
goto 10;print_nl(1283);goto 10;end;10:end;
{:1335}{1336:}procedure init_prim;begin no_new_control_sequence:=false;
{226:}primitive(376,75,600782);primitive(377,75,600783);
primitive(378,75,600784);primitive(379,75,600785);
primitive(380,75,600786);primitive(381,75,600787);
primitive(382,75,600788);primitive(383,75,600789);
primitive(384,75,600790);primitive(385,75,600791);
primitive(386,75,600792);primitive(387,75,600793);
primitive(388,75,600794);primitive(389,75,600795);
primitive(390,75,600796);primitive(391,76,600797);
primitive(392,76,600798);primitive(393,76,600799);
{:226}{230:}primitive(398,72,601313);primitive(399,72,601314);
primitive(400,72,601315);primitive(401,72,601316);
primitive(402,72,601317);primitive(403,72,601318);
primitive(404,72,601319);primitive(405,72,601320);
primitive(406,72,601321);{:230}{238:}primitive(420,73,603163);
primitive(421,73,603164);primitive(422,73,603165);
primitive(423,73,603166);primitive(424,73,603167);
primitive(425,73,603168);primitive(426,73,603169);
primitive(427,73,603170);primitive(428,73,603171);
primitive(429,73,603172);primitive(430,73,603173);
primitive(431,73,603174);primitive(432,73,603175);
primitive(433,73,603176);primitive(434,73,603177);
primitive(435,73,603178);primitive(436,73,603179);
primitive(437,73,603180);primitive(438,73,603181);
primitive(439,73,603182);primitive(440,73,603183);
primitive(441,73,603184);primitive(442,73,603185);
primitive(443,73,603186);primitive(444,73,603187);
primitive(445,73,603188);primitive(446,73,603189);
primitive(447,73,603190);primitive(448,73,603191);
primitive(449,73,603192);primitive(450,73,603193);
primitive(451,73,603194);primitive(452,73,603195);
primitive(453,73,603196);primitive(454,73,603197);
primitive(455,73,603198);primitive(456,73,603199);
primitive(457,73,603200);primitive(458,73,603201);
primitive(459,73,603202);primitive(460,73,603203);
primitive(461,73,603204);primitive(462,73,603205);
primitive(463,73,603206);primitive(464,73,603207);
primitive(465,73,603208);primitive(466,73,603209);
primitive(467,73,603210);primitive(468,73,603211);
primitive(469,73,603212);primitive(470,73,603213);
primitive(471,73,603214);primitive(472,73,603215);
primitive(473,73,603216);primitive(474,73,603217);
{:238}{248:}primitive(478,74,603730);primitive(479,74,603731);
primitive(480,74,603732);primitive(481,74,603733);
primitive(482,74,603734);primitive(483,74,603735);
primitive(484,74,603736);primitive(485,74,603737);
primitive(486,74,603738);primitive(487,74,603739);
primitive(488,74,603740);primitive(489,74,603741);
primitive(490,74,603742);primitive(491,74,603743);
primitive(492,74,603744);primitive(493,74,603745);
primitive(494,74,603746);primitive(495,74,603747);
primitive(496,74,603748);primitive(497,74,603749);
primitive(498,74,603750);{:248}{265:}primitive(32,64,0);
...
hash[600516].rh:=516;eqtb[600516]:=eqtb[cur_val];primitive(517,102,0);
...
primitive(535,0,256);hash[600521].rh:=535;eqtb[600521]:=eqtb[cur_val];
...
{:487}{491:}primitive(774,106,2);hash[600518].rh:=774;
eqtb[600518]:=eqtb[cur_val];primitive(775,106,4);primitive(776,106,3);
{:491}{553:}primitive(801,87,0);hash[600524].rh:=801;
eqtb[600524]:=eqtb[cur_val];{:553}{780:}primitive(898,4,256);
primitive(899,5,257);hash[600515].rh:=899;eqtb[600515]:=eqtb[cur_val];
primitive(900,5,258);hash[600519].rh:=901;hash[600520].rh:=901;
eqtb[600520].hh.b0:=9;eqtb[600520].hh.rh:=7999989;eqtb[600520].hh.b1:=1;
eqtb[600519]:=eqtb[600520];eqtb[600519].hh.b0:=115;
...
primitive(877,49,31);hash[600517].rh:=877;eqtb[600517]:=eqtb[cur_val];
...
{:1222}{1230:}primitive(415,85,601883);primitive(419,85,602907);
primitive(416,85,602139);primitive(417,85,602395);
primitive(418,85,602651);primitive(477,85,603474);
primitive(412,86,601835);primitive(413,86,601851);
primitive(414,86,601867);{:1230}{1250:}primitive(941,99,0);
...
{:1277}{1286:}primitive(1237,57,602139);primitive(1238,57,602395);
{:1286}{1291:}primitive(1239,19,0);primitive(1240,19,1);
primitive(1241,19,2);primitive(1242,19,3);
{:1291}{1344:}primitive(1285,59,0);primitive(594,59,1);
write_loc:=cur_val;primitive(1286,59,2);primitive(1287,59,3);
primitive(1288,59,4);primitive(1289,59,5);{:1344};
...
while true do begin;print_nl(1284);break(term_out);read(term_in,m);
...
if 1100>8000000 then bad:=4;if 1777>600000 then bad:=5;
if max_in_open>=128 then bad:=6;if 8000000<267 then bad:=7;
{:14}{111:}if(mem_min<>0)or(mem_max<>8000000)then bad:=10;
if(mem_min>0)or(mem_max<8000000)then bad:=10;
...
{:111}{290:}if 604876>65535 then bad:=21;
{:290}{522:}if 20>file_name_size then bad:=31;
{:522}{1249:}if 2*65535<8000000-mem_min then bad:=41;
...
{:55}{61:}write(term_out,'This is TeX, Version 3.141592653');
...
if(eqtb[603211].int<0)or(eqtb[603211].int>255)then cur_input.limit_field
:=cur_input.limit_field-1 else buffer[cur_input.limit_field]:=eqtb[
603211].int;fix_date_and_time;
{765:}magic_offset:=str_start[892]-9*16{:765};
{75:}if interaction=0 then selector:=16 else selector:=17{:75};
if(cur_input.loc_field<cur_input.limit_field)and(eqtb[601883+buffer[
